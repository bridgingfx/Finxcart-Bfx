                ...
                <div class="col-lg-6">
                    <div class="card mb-3">
                        <div class="card-header d-flex gap-2 flex-wrap align-items-center justify-content-between">
                            ...
                            <form action="{{route('admin.contact.update',$contact->id)}}" method="post" id="submit-form" novalidate>
                                @csrf
                        ...
                        <div class="card-body mt-3 mx-lg-4">
                            <div class="row text-start">
                                <div class="col-12">
                                    ...
                                    <form action="{{route('admin.contact.send-mail', $contact->id)}}" method="post" novalidate>
                                        @csrf
