                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.banner.update', [$banner['id']]) }}" method="post"
                              enctype="multipart/form-data" class="banner_form" novalidate>
                            @csrf
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="h-100">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="title" class="form-control" id="title" required
                                                   placeholder="{{ translate('Enter_banner_title') }}" value="{{ $banner['title'] }}">
                                        </div>

                                        <div class="form-group mb-3">
                                            <label for="name" class="form-label">{{ translate('Sub_Title') }}</label>
                                            <input type="text" name="sub_title" class="form-control" id="sub_title" required
                                                   placeholder="{{ translate('Enter_banner_sub_title') }}" value="{{ $banner['sub_title'] }}">
                                        </div>
