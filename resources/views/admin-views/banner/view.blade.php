                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="h-100">
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="sub_title" class="form-label">{{ translate('Sub_Title') }}</label>
                                    ...
                                    <tr id="data-{{ $banner->id}}">
                                        ...
                                        <td>
                                            <form action="{{ route('admin.banner.status') }}" method="post"
                                                  id="banner-status{{ $banner['id'] }}-form" class="no-reload-form" novalidate>
                                                @csrf
