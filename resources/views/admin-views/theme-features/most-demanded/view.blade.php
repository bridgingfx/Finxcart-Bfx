...
<div class="content container-fluid">
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('admin.most-demanded.store') }}" method="post" class="text-start" enctype="multipart/form-data" novalidate>
                        @csrf
                        <div class="row g-4">
                            <div class="col-lg-6">
                                <div class="h-100">
            ...
            <div class="d-flex justify-content-between align-items-center gap-20 flex-wrap">
                ...
                <div class="d-flex flex-wrap gap-3 align-items-center justify-content-sm-end flex-grow-1">
                    <div class="flex-grow-1 max-w-280">
                        <form action="{{route('admin.most-demanded.index') }}" method="GET" novalidate>
                        ...
                        <tr id="data-{{ $mostDemanded->id}}">
                            ...
                            <td>
                                    ...
                                    <form action="{{route('admin.most-demanded.status-update') }}" method="post" id="most-demanded{{ $mostDemanded['id']}}-form"
                                          class="most-demanded-status-form" novalidate>
                                        @csrf
