...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card mb-3">
            <form action="{{ route('admin.third-party.social-media-chat.update',['whatsapp']) }}" method="post" novalidate>
                @csrf
                ...
                <div class="d-flex flex-column gap-20">
                    @if (isset($socialLoginServices))
                        @foreach ($socialLoginServices as $socialLoginService)
                            <div class="card card-sm shadow-1">
                                <div class="card-body">
                                    <form action="{{ route('admin.third-party.social-login.update',[$socialLoginService['login_medium']]) }}"
                    ...
                    @if(isset($appleLoginServices))
                        @foreach ($appleLoginServices as $appleLoginService)
                            <div class="card card-sm shadow-1">
                                <div class="card-body">
                                    <form action="{{ route('admin.third-party.social-login.update-apple', [$appleLoginService['login_medium']]) }}"
