                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-3">
                            ...
                            <div class="d-flex gap-3 flex-wrap align-items-center">
                                <form action="{{ route('admin.third-party.offline-payment-method.index') }}" method="GET" novalidate>
                                ...
                                <tbody>
                                    @foreach ($methods as $key=>$method)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{route('admin.third-party.offline-payment-method.update-status')}}" method="post" id="method-status{{$method['id']}}-form" class="method-status-form" novalidate>
                                                    @csrf
                                            ...
                                            <td>
                                                ...
                                                <form action="{{route('admin.third-party.offline-payment-method.delete')}}" method="post" id="delete-method-name-{{ $method->id }}" novalidate>
                                                    @csrf
