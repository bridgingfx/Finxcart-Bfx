...
@section('content')
    @php($fcmCredentials = getWebConfig(name: 'fcm_credentials') ?? [])
    @php($firebaseWebApiKey = $firebaseOtpVerification['web_api_key'] ?: ($fcmCredentials['apiKey'] ?? ''))
                            ...
                            <div class="form-group mb-20px">
                                <div class="mb-3 d-flex gap-3 flex-wrap justify-content-between align-items-center">
                                    ...
                                    <button class="btn btn-outline-primary" type="button" data-bs-toggle="modal"
                                            data-bs-target="#send-sms-confirmation-modal">
                                ...
                                <div class="bg-white p-3 rounded">
                                    <div class="row g-4">
                                        <div class="col-xl-6 col-md-6">
                                            <div class="form-check d-flex gap-3">
                                                <form action="{{ route('admin.third-party.firebase-configuration.update') }}" class=""
                                                      method="post" id="sms-configuration-third-party-form" novalidate>
                                                    @csrf
                                                    <input type="hidden" name="web_api_key" value="{{ $firebaseWebApiKey }}">
                                                    <input
                                        ...
                                        <div class="col-xl-6 col-md-6">
                                            <div class="form-check d-flex gap-3">
                                                <form action="{{ route('admin.third-party.firebase-configuration.update') }}" class=""
                                                      method="post" id="sms-configuration-firebase-form" novalidate>
                                                    @csrf
                                                    <input type="hidden" name="web_api_key" value="{{ $firebaseWebApiKey }}">
                                                    <input
                                                        class="form-check-input radio--input radio--input_lg custom-modal-plugin"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{route('admin.third-party.addon-sms-set')}}" method="POST"
                                  id="sms-{{$smsConfig['key_name']}}-form" enctype="multipart/form-data" novalidate>
                                @csrf @method('PUT')
                                    <?php
    ...
    <div class="modal fade" id="send-sms-confirmation-modal" tabindex="-1"
     aria-labelledby="send-sms-confirmation-modal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body px-20 py-0 mb-30">
                    <form action="{{ route('admin.third-party.send-test-sms') }}" method="post" novalidate>
                        @csrf
