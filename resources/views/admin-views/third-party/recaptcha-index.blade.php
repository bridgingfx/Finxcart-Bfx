...
@section('content')
    <div class="content container-fluid">
        ...
        <form action="{{ env('APP_MODE') != 'demo' ? route('admin.third-party.captcha') : 'javascript:' }}"
              method="POST" id="recaptcha-status-form" novalidate>
            @csrf
            <div class="card mb-3">
                <div class="card-body">
            ...
            <div class="bg-info bg-opacity-10 fs-12 px-12 py-10 text-dark rounded-8 mb-3 version-content">
                <div class="d-flex gap-2 align-items-center justify-content-between mb-2">
                    <div class="d-flex gap-2 align-items-center">
                        ...
                        <div>
                            <h4 class="fw-medium mb-1">{{ translate('v2_version_is_available_now_must_setup_for_recaptcha_v2') }}</h4>
                            <span>{{ translate('you_must_setup_for_v2_version_otherwise_the_default_recaptcha_will_be_displayed_automatically') }}</span>
                        </div>
                    </div>
                    <div>
