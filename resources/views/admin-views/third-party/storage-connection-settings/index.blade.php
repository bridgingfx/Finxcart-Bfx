                                    ...
                                    <div class="row g-4">
                                        <div class="col-xl-6 col-md-6">
                                            <div class="form-check d-flex gap-3">
                                                <form action="{{ route('admin.third-party.storage-connection-settings.update-storage-type') }}"
                                                    method="post" id="storage-connection-local-form"
                                                    data-from="storage-connection-type" novalidate>
                                                    @csrf
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('admin.third-party.storage-connection-settings.s3-credential') }}" method="POST"
                      id="get-storage-connection-route" novalidate>
                    @csrf
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="p-12 p-sm-20 bg-section rounded-8">
