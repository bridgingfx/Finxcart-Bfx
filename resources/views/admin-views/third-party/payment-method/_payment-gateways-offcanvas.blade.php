<form action="{{ route('admin.third-party.payment-method.addon-payment-set') }}" method="POST"
      id="{{$gateway->key_name}}-form" enctype="multipart/form-data" novalidate>
    @csrf @method('PUT')
                ...
                <div class="upload-file">
                    ...
                    <label
                        ...
                        <img class="upload-file-img" loading="lazy"
                            src="{{ getValidImage(path:'storage/app/public/payment_modules/gateway_image/'.($additionalData->gateway_image ?? ''), type: 'backend-payment' ) }}"
                            data-default-src="{{ getValidImage(path:'storage/app/public/payment_modules/gateway_image/'.($additionalData->gateway_image ?? ''), type: 'backend-payment' ) }}"
                            alt="">
                    </label>
                    <div class="overlay">
