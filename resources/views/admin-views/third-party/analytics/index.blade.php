            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ env('APP_MODE') != 'demo' ? route('admin.third-party.analytics-update') : 'javascript:' }}" method="post" enctype="multipart/form-data" id="google-analytics-status-form" novalidate>
                            @csrf
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ env('APP_MODE') != 'demo' ? route('admin.third-party.analytics-update') : 'javascript:' }}"
                            method="post" enctype="multipart/form-data"
                            id="google-tag-manager-status-form" novalidate>
                            @csrf
                            <div class="view-details-container">
                                <div class="d-flex justify-content-between align-items-center gap-3">
                                    <div>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ env('APP_MODE') != 'demo' ? route('admin.third-party.analytics-update') : 'javascript:' }}"
                            method="post" enctype="multipart/form-data"
                            id="linkedin-insight-status-form" novalidate>
                            @csrf
                            <div class="view-details-container">
                                <div class="d-flex justify-content-between align-items-center gap-3">
                                    <div>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ env('APP_MODE') != 'demo' ? route('admin.third-party.analytics-update') : 'javascript:' }}"
                            method="post" enctype="multipart/form-data"
                            id="meta-pixel-status-form" novalidate>
                            @csrf
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ env('APP_MODE') != 'demo' ? route('admin.third-party.analytics-update') : 'javascript:' }}"
                            method="post" enctype="multipart/form-data"
                            id="pinterest-tag-status-form" novalidate>
                            @csrf
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ env('APP_MODE') != 'demo' ? route('admin.third-party.analytics-update') : 'javascript:' }}"
                            method="post" enctype="multipart/form-data"
                            id="snapchat-tag-status-form" novalidate>
                            @csrf
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ env('APP_MODE') != 'demo' ? route('admin.third-party.analytics-update') : 'javascript:' }}"
                            method="post" enctype="multipart/form-data"
                            id="tiktok-tag-status-form" novalidate>
                            @csrf
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ env('APP_MODE') != 'demo' ? route('admin.third-party.analytics-update') : 'javascript:' }}"
                            method="post" enctype="multipart/form-data"
                            id="twitter-tag-status-form" novalidate>
                            @csrf
