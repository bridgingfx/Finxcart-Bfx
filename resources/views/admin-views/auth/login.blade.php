...
<main id="content" role="main" class="main">
    <div class="auth-wrapper">
        ...
        <div class="auth-wrapper-left"
             style="background: url('{{ dynamicAsset('public/assets/back-end/img/login_page_banner.png') }}') no-repeat center center / cover">
            {{-- <div class="auth-left-cont user-select-none">
                @php($eCommerceLogo = getWebConfig(name: 'company_footer_logo'))
        ...
        <div class="auth-wrapper-right">
            ...
            <div class="auth-wrapper-form">
                <form id="form-id" action="{{route('login') }}" method="post" id="admin-login-form" novalidate>
                    @csrf
                    <div>
                        <div class="mb-4 user-select-none">
                            <h1 class="h2 mb-2">{{ translate('sign_in') }}</h1>
                            <h1 class="h5 text-body fw-normal mb-0">
                    ...
                    <div class="js-form-message form-group">
                        ...
                        <input type="email" class="form-control form-control-lg" name="email" id="signingAdminEmail"
                               ...
                               autocomplete="off" required data-msg="Please enter a valid email address.">
                    </div>
                    <div class="js-form-message form-group">
