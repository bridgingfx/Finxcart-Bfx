    ...
    <div class="content container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <div class="p-12 p-sm-20 bg-section rounded">
                    <form action="{{ route('admin.business-settings.shipping-type.index') }}" method="post" id="shipping-type-form" novalidate>
                        @csrf
                    ...
                    <div class="d-flex flex-column gap-20">
                        <div class="card card-sm shadow-2">
                            <div class="card-body">
                                ...
                                <form action="{{route('admin.business-settings.shipping-method.index')}}" method="post" novalidate>
                                    @csrf
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="{{ route('admin.business-settings.shipping-method.update-status') }}"
                                                            method="post" id="shipping-methods{{ $method['id'] }}-form" class="no-reload-form" novalidate>
                                                            @csrf
