<div class="inline-page-menu my-4">
    <ul class="nav nav-pills nav--tab gap-3">
        ...
        <li class="nav-item"><a class="nav-link {{ Request::is('admin/transaction/commission-ledger') ?'active':'' }}" href="{{route('admin.transaction.commission-ledger')}}">{{translate('commission_Ledger')}}</a></li>
