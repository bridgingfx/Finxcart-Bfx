            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body text-start">
                        <form action="{{ $category['position'] == 2 ? route('admin.sub-sub-category.update', [$category['id']]) : ($category['position'] == 1 ? route('admin.sub-category.update', [$category['id']]) : route('admin.category.update', [$category['id']])) }}" method="POST"
                                        ...
                                        <div class="d-flex flex-column gap-30">
                                            <div class="text-center">
                                                <label for="" class="form-label fw-semibold mb-1">
                                                    {{ $category['position'] == 1 ? translate('sub_category_Logo') : translate('category_Logo') }}
                                                </label>
