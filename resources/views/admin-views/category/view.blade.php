...
@section('content')
                                    ...
                                    <div class="h-100">
                                        <div class="tab-content" id="pills-tabContent">
                                            ...
                                            <div class="form-group tab-pane fade {{ $lang == $defaultLanguage ? 'show active' : '' }}" id="{{ $lang }}-form" aria-labelledby="{{ $lang }}-link" role="tabpanel">
                                                <label class="form-label">{{ translate('category_Name') }}<span class="text-danger">*</span> ({{ strtoupper($lang) }})</label>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <form action="{{ route('admin.category.status') }}" method="post"
                                                    id="category-status{{ $category['id'] }}-form" class="no-reload-form" novalidate>
                                                    @csrf
    ...
    <span id="route-admin-category-delete-info" data-url="{{ route('admin.category.delete-info') }}"></span>
    @include("layouts.admin.partials.offcanvas._category-setup")
@endsection

@push('script')
    <script src="{{ dynamicAsset(path: 'public/assets/backend/admin/js/products/products-management.js') }}?v={{ time() }}"></script>
@endpush
