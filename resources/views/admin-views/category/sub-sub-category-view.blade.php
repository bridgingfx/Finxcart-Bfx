...
@section('content')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body text-start">
                        <form action="{{ route('admin.sub-sub-category.store') }}" method="POST" novalidate>
                            @csrf
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label text-capitalize" for="priority">
                                                {{ translate('priority') }}
                                                <span>
                                                    <i class="fi fi-rr-info" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ translate('the_lowest_number_will_get_the_highest_priority') }}"></i>
                                                </span>
                                            </label>
                                            <div class="select-wrapper">
    ...
    <span id="route-admin-category-delete-info" data-url="{{ route('admin.sub-sub-category.delete-info') }}"></span>
@endsection
