...
<div class="withdraw-info-sidebar d-flex justify-content-between flex-column">
    <div class="withdraw-details">
        ...
        <div class="d-flex flex-column align-items-center gap-1 mb-3">
            ...
            <div class="d-flex gap-2 align-items-center mb-1 flex-wrap">
                ...
                <label class="badge {{$details['approved'] == 1 ? 'badge-soft-success' : ($details['approved'] == 0 ? 'badge-soft-warning':'badge-soft-danger')}} mb-0">{{translate($details['approved'] == 1 ? 'approved' : ($details['approved'] == 0 ? 'pending':'denied'))}}</label>
            </div>
    ...
    <div class="d-none note-section">
        ...
        <form action="{{route('admin.delivery-man.withdraw-update-status',[$details['id']])}}" method="POST" id="approval-note-form" novalidate>
            @csrf
        ...
        <form action="{{route('admin.delivery-man.withdraw-update-status',[$details['id']])}}" method="POST" id="denial-note-form" novalidate>
            @csrf
