...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <form action="{{route('admin.delivery-man.emergency-contact.add')}}" method="post" novalidate>
                    @csrf
                    <div class="card">
                        <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <form action="{{route('admin.delivery-man.emergency-contact.ajax-status-change')}}" method="post" id="emergency-contact-status{{$contact->id}}-form" class="no-reload-form" novalidate>
                                            @csrf
                                ...
                                <td>
                                    ...
                                    <form action="{{route('admin.delivery-man.emergency-contact.destroy')}}"
                                          method="post" id="delete-contact-{{$contact->id}}" novalidate>
                                        @csrf @method('delete')
