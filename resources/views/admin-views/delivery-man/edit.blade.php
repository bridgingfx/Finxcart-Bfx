                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" value="{{$deliveryMan['f_name']}}" name="f_name" class="form-control" placeholder="{{translate('new_delivery_man')}}" required>
                                    </div>
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group mb-3">
                                            <div>
                                                <select class="js-example-basic-multiple js-states js-example-responsive form-sel max-w-140"
                                            ...
                                            <input type="text" name="phone" value="{{$deliveryMan['phone']}}" class="form-control" placeholder="{{translate('ex').':'.'017********'}}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="mb-4">
                                        <label
                                            class="mb-2 d-flex">{{translate('identity_Type')}}</label>
                                    ...
                                    <div class="mb-4">
                                        <label
                                            class="mb-2 d-flex">{{translate('identity_Number')}}</label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-4">
                                        ...
                                        <div class="mt-4 text-center">
                                            <img class="upload-img-view" id="viewer" src="{{ getStorageImages(path:$deliveryMan->image_full_url, type: 'backend-profile') }}" alt=""/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                                ...
                                                @if($deliveryMan['identity_image'])
                                                    @foreach($deliveryMan->identity_images_full_url as $img)
                                                        <div class="col-md-4 mb-3">
                                                            <img height="150" alt="" src="{{getStorageImages(path:$img,type:'backend-basic')}}">
                                                        </div>
                                                    @endforeach
                                                @endif
                                            </div>
                    ...
                    <div class="card mt-3">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-4">
                                    <label for="confirm_password" class="mb-2 d-flex gap-1 align-items-center">{{translate('confirm_password')}}</label>
                                    <div class="input-group">
