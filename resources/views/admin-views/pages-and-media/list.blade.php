            ...
            <div class="card-body">
                <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center mb-3">
                    ...
                    <div class="d-flex gap-10 justify-content-sm-end">
                        <form action="{{ route('admin.pages-and-media.list') }}" method="get" novalidate>
                                ...
                                <td>
                                    ...
                                    @else
                                        <form action="{{ route('admin.pages-and-media.update-status') }}"
                                              method="post" id="language-id-{{ $businessPage['id'] }}-form" class="no-reload-form reload-true" novalidate>
                                            @csrf
