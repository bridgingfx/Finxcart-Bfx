<form action="{{ route('admin.pages-and-media.social-media-update',  ['id'=>$socialMediaLink['id']]) }}" method="post" id="" novalidate>
    @csrf
...
<form action="{{ route('admin.pages-and-media.social-media-delete') }}" method="post" novalidate>
