...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-body">
                <form action="{{ route('admin.pages-and-media.social-media-store') }}" method="post" style="text-align: {{$direction === "rtl" ? 'right' : 'left'}};" id="social-media-links" novalidate>
                    @csrf
                            ...
                            @foreach($socialMediaLinks as $key => $socialMediaLink)
                                <tr>
                                    ...
                                    <td class="column_name" data-column_name="status" data-id="1">
                                        <form action="{{route('admin.pages-and-media.social-media-status-update', ['id'=>$socialMediaLink['id']]) }}" method="post" id="social-media-status{{ $socialMediaLink->id }}-form" class="" novalidate>
                                            @csrf
