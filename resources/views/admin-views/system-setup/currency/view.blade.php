...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('admin.system-setup.currency.store') }}" method="post" novalidate>
                    @csrf
                    <div class="p-12 p-sm-20 bg-section rounded">
                        <div class="row g-4">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="form-label text-capitalize" for="symbol">
                                        {{ translate('currency_svg') }}
                                        <span class="text-danger"></span>
                                        <span class="tooltip-icon" data-bs-toggle="tooltip"
                                              data-bs-placement="right"
                                              aria-label="{{ translate('add_the_svg_code_of_the_currency_you_want_to_add') }}"
                                              data-bs-title="{{ translate('add_the_svg_code_of_the_currency_you_want_to_add') }}">
                                                    <i class="fi fi-sr-info"></i>
                                                </span>
                                    </label>
                                    <textarea name="symbol_svg" class="form-control" rows="4"  placeholder="{{ translate('add_the_svg_code_of_the_currency_you_want_to_add') }}"></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
    ...
    @foreach($currencies as $key =>$currency)
        <form action="{{ route('admin.system-setup.currency.delete') }}" method="post" novalidate>
            @csrf
