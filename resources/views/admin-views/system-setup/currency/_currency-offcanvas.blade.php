@foreach($currencies as $key =>$currency)
    <form action="{{ route('admin.system-setup.currency.update') }}" method="post" novalidate>
        @csrf
                ...
                <div class="mb-3 mb-sm-20">
                    <div class="p-12 p-sm-20 bg-section rounded">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="symbol_svg" class="form-control" rows="4"  placeholder="{{ translate('add_the_svg_code_of_the_currency_you_want_to_add') }}">{{ old('symbol_svg', $currency['symbol_svg']) }}</textarea>
                        </div>
                        <div class="form-group">
