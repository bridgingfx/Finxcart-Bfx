...
@section('content')
    <div class="content container-fluid">
        ...
        <form action="{{ route('admin.system-setup.login-settings.customer-login-setup') }}" method="post"
              enctype="multipart/form-data" id="customer-login-setup-update" novalidate>
            @csrf
                                                ...
                                                <div class="form-check d-flex gap-10">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <p class="fs-12 mb-0">
                                                            ...
                                                            <a  href="{{ route('admin.pages-and-media.social-media') }}" target="_blank" class="text-decoration-underline">{{ translate('configure_social_media_setup') }}</a>
                                                            {{ translate('here') }}.
                                                        </p>
                                                    </div>
                                                </div>
