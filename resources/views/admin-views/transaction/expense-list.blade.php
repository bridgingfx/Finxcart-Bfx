        ...
        <div class="d-flex flex-wrap gap-3 mb-3">
            <div class="d-flex flex-column gap-3 flex-grow-1 expense--content">
                <div class="card card-body">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="info">
                            <h4 class="subtitle h1">{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $total_expense), currencyCode: getCurrencyCode()) }}</h4>
                            <h5 class="subtext">
                                <span>{{translate('total_Expense')}}</span>
                                <span class="ml-2" data-bs-toggle="tooltip"
                                      data-bs-title="{{translate('free_delivery')}}, {{translate('coupon_discount_will_be_shown_here')}}">
                ...
                <div class="card card-body">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="info">
                            <h4 class="subtitle h1">{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $free_delivery), currencyCode: getCurrencyCode()) }}</h4>
                ...
                <div class="card card-body">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="info">
                            <h4 class="subtitle h1">{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $coupon_discount), currencyCode: getCurrencyCode()) }}</h4>
                            <h5 class="subtext">
            ...
            <div class="center-chart-area flex-grow-1">
                @include('layouts.admin.partials._apexcharts',[
                    ...
                    'label' => array_keys($expense_transaction_chart['discount_amount']),
            ...
            <div class="card-body">
                <div class="d-flex flex-wrap gap-3 align-items-center justify-content-between mb-4">
                    <h4 class="mb-0">
                        ...
                        <span class="badge badge-info text-bg-info">{{ $expense_transactions_table->total() }}</span>
                    </h4>

                    <div class="d-flex flex-wrap gap-3">
                        <form action="" method="GET" class="mb-0" novalidate>
