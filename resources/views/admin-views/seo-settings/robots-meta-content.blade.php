            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('admin.seo-settings.robots-meta-content.add-page') }}" method="POST" novalidate>
                            @csrf
                            <div class="mb-3">
                                <label class="form-label">{{translate('Page_Name')}}</label>
                                <div class="select-wrapper">
                                    <select class="form-select bg-white" name="page_name" required id="robotsMetaContentPageSelect">
