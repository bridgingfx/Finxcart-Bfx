                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{route('admin.vendors.withdraw-method.default-status')}}" method="post"
                                          ...
                                          class="no-reload-form reload-true" novalidate>
                                        @csrf
                                        <input type="hidden" name="id" value="{{$withdrawalMethod['id']}}">
                                ...
                                <td>
                                    ...
                                    <form action="{{route('admin.vendors.withdraw-method.delete',[$withdrawalMethod->id])}}" method="post" id="delete-{{$withdrawalMethod->id}}" novalidate>
                                        @csrf @method('delete')
                                    </form>
                                </td>
                            </tr>
