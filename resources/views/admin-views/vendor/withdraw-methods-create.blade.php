...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="{{route('admin.vendors.withdraw-method.add')}}" method="POST" novalidate>
                    @csrf
                                ...
                                <div class="row gy-4 align-items-center">
                                    <div class="col-md-6">
                                        ...
                                        <select class="custom-select" name="field_type[]" required>
                                            ...
                                            <option value="file">{{translate('file_upload')}}</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="">
    ...
    <span id="get-add-filed-text"
          ...
          data-file="{{translate('file_upload')}}"
