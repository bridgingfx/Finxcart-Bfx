                                    ...
                                    @if (isset($order->verificationImages) && count($order->verificationImages)>0 && $order->verification_status ==1)
                                        <div>
                                            <button class="btn btn-primary px-4" data-bs-toggle="modal"
                                                    ...
                                                    class="fi fi-rr-badge-check"></i> {{translate('order_verification')}}
                                            </button>
                                        </div>
                                    @endif
                                    <div class="">
                                        @if (isset($shipping_address['latitude']) && isset($shipping_address['longitude']))
                                            <button class="btn btn-primary px-4" data-bs-toggle="modal"
                                                    ...
                                                    class="fi fi-rr-map"></i> {{translate('show_locations_on_map')}}
                                            </button>
                                        @else
                                            <button class="btn btn-warning px-4">
                                                <i class="fi fi-rr-map"></i> {{translate('shipping_address_has_been_given_below')}}
                                            </button>
                                        @endif
                                    </div>
