...
@section('content')
    <div class="content container-fluid">
        ...
        <form action="{{route('admin.vendors.withdraw-method.update')}}" method="POST" novalidate>
            @csrf
            ...
            <div class=" p-30">
                            ...
                            <div class="col-md-6">
                                <div class="">
                                    ...
                                    <select class="custom-select" name="field_type[]" required>
                                        ...
                                        <option value="file" {{($field['input_type']??$field)=='file'?'selected':''}}>{{translate('file_upload')}}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="row gy-4 align-items-center">
                                    <div class="col-md-6">
                                        <div>
                                            ...
                                            <option value="file" {{$field['input_type']=='file'?'selected':''}}>{{translate('file_upload')}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                ...
                <div class="d-flex mt-3">
                    <div class="d-flex align-items-center gap-1">
                        <input class="form-check-input checkbox--input" type="checkbox" value="1" name="is_default" id="flex-check-default-method" {{$withdrawalMethod['is_default'] == 1 ? 'checked' : ''}}>
