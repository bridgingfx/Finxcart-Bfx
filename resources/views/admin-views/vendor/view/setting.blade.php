...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="row g-3">
            <div class="col-md-6">
                <form action="{{ route('admin.vendors.update-setting',['id'=>$seller['id']]) }}" method="post" id="update-setting-form-0" novalidate>
                    @csrf
                    <div class="card">
            ...
            <div class="col-md-6">
                <form action="{{ route('admin.vendors.update-setting',['id'=>$seller['id']]) }}" method="post" id="update-setting-form-1" novalidate>
                    @csrf
                    <div class="card">
                        <div class="card-header d-flex justify-content-between gap-2">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.vendors.update-setting',['id'=>$seller['id']]) }}" method="post" id="update-setting-form-2" novalidate>
                            @csrf
