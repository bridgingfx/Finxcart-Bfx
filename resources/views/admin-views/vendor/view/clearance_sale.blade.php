            ...
            <div class="modal-content" style="max-height: 80vh; overflow-y: auto;">
                <div class="modal-header">
                    <button type="button" class="close p-0 fz-22" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true"><i class="fi fi-rr-cross"></i></span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{{route('vendor.clearance-sale.update-discount')}}" method="post" class="discount-amount-update" novalidate>
                        @csrf
