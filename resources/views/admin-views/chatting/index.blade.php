...
@section('content')
    <div class="content container-fluid">
                                                ...
                                                <div class="list_filter">
                                                    <div class="chat_list p-3 d-flex gap-2 {{ $key == 0 ? 'bg-soft-secondary' : ''}} get-ajax-message-view {{ $chatting->delivery_man_id == $lastChatUser->id ? 'active' : '' }}"
                                                        ...
                                                        <div class="chat_people media gap-10 w-100 d-flex align-items-center" id="chat_people">
                                                            ...
                                                            <div class="chat_ib media-body">
                                                                <h4 class="mb-1 seller {{ $key != 0 ?'font-weight-normal' :''}}"
        ...
        <span id="chatting-typing-url"
              data-url="{{ Request::is('admin/messages/index/customer') ? route('admin.messages.typing').'?user_id=' : route('admin.messages.typing').'?delivery_man_id=' }}"></span>
        <span id="chatting-typing-status-url"
              data-url="{{ Request::is('admin/messages/index/customer') ? route('admin.messages.typing-status').'?user_id=' : route('admin.messages.typing-status').'?delivery_man_id=' }}"></span>
    ...
    <span id="get-video-preview-icon" data-video-icon="{{ dynamicAsset('public/assets/back-end/img/icons/carbon_play-filled.svg') }}"></span>
@endsection
