            ...
            <div class="col-md-4 col-xl-3">
                <div class="d-flex justify-content-between align-items-center border rounded px-3 py-2">
                    ...
                    <form action="{{ route('admin.deal.clearance-sale.status-update') }}" data-from="clearance-sale"
                          method="post" id="clearance-sale-status-form" class="no-reload-form" novalidate>
                        @csrf
...
<div class="card mb-3">
    <div class="card-body">
        <form action="{{ route('admin.deal.clearance-sale.update-config') }}" method="POST" novalidate>
            @csrf
