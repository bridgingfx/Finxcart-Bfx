            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body d-flex flex-column gap-20">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="overflow-hidden max-w-100px">
                                            <span data-bs-toggle="tooltip" data-bs-placement="right" area-label="{{ $brand['defaultname'] }}" data-bs-title="{{ $brand['defaultname'] }}">
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-3">
                                                ...
                                                <a class="btn btn-outline-danger icon-btn delete-brand" title="{{ translate('delete') }}"
                        ...
                        @if(count($brands)==0)
                            @include('layouts.admin.partials._empty-state',['text'=>'no_brand_found'],['image'=>'default'])
                        @endif
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content shadow-lg">
                ...
                <div class="modal-body px-4 px-sm-5 pt-0 pb-sm-5">
                    ...
                    <form action="{{ route('admin.brand.delete') }}" method="post" class="product-brand-update-form-submit" novalidate>
                        @csrf
