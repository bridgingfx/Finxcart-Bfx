    ...
    <div class="col-md-6">
        <div class="tab-content" id="pills-tabContent">
            @foreach($language as $lang)
                <?php
                    $translate = [];
                    if ($brand && count($brand['translations'])) {
                ...
                <div
                    ...
                    <input type="text" name="name[]"
                           value="{{ $brand ? ($lang == $defaultLanguage ? $brand['name'] : ($translate[$lang]['name'] ?? '')) : '' }}"
        ...
        <div class="d-flex flex-column gap-20">
            ...
            <div class="upload-file">
                <input type="file" name="image" id="brand-image"
                       ...
                       accept=".webp, .jpg, .jpeg, .png" value="" {{ $brand ? '' : 'required' }}>
                <label
                    ...
                    <img class="upload-file-img" loading="lazy"
                         src="{{ $brand ? (getStorageImages($brand->image_full_url, 'backend-brand') ?? '') : '' }}"
                         data-default-src="{{ $brand ? (getStorageImages($brand->image_full_url, 'backend-brand') ?? '') : '' }}"
                         alt="">
                </label>
                <div class="overlay">
                    <div
