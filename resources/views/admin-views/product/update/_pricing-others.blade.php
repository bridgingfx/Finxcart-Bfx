<div class="card mt-3 rest-part show-for-product-radio {{ $currentListingType == 'product' ? '' : 'd-none' }}">
    ...
    <div class="card-body">
        <div class="row gy-4 align-items-end">
            ...
            <div class="col-md-6 col-lg-4 col-xl-3 show-for-physical-product" id="minimum_order_qty">
                <div class="form-group">
            ...
            <div class="col-md-6 col-lg-4 col-xl-3 show-for-physical-product" id="shipping_cost">
                <div class="form-group">
                    ...
                    <input type="number" min="0" value="{{ usdToDefaultCurrency($product->shipping_cost) }}" step="0.01"
