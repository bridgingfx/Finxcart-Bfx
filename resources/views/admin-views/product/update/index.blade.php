...
@section('content')
    <div class="content container-fluid">
        ...
        <form class="product-form text-start" enctype="multipart/form-data" id="product_form"
              action="{{ request('product-gallery') == 1 ? route('admin.products.add') : route('admin.products.update', $product->id) }}" method="POST" novalidate>
            @csrf
...
@push('script')
    ...
    <script src="{{ dynamicAsset(path: 'public/assets/backend/admin/js/products/category-repeater.js') }}"></script>
