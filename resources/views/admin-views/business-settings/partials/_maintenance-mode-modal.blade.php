<div class="modal fade" id="maintenance-mode-modal" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <form method="post" action="{{ route('admin.business-settings.maintenance-mode') }}" class="modal-content" id="maintenance-mode-form" novalidate>
            @csrf
            <div class="modal-header p-4 border-0 justify-content-between">
                <h3 class="mb-0">
                    <i class="fi fi-rr-bell mr-1"></i>
