<div class="card mt-2 top-vendor">
    <div class="card-body">
        ...
        <div class="p-12 p-sm-20 bg-section rounded">
            <form action="{{route('admin.business-settings.priority-setup.index',['type'=>'top_vendor'])}}" method="post" novalidate>
                @csrf
                        ...
                        <div class="row g-4">
                            <div class="col-xl-6 col-md-6">
                                <div class="form-check d-flex gap-2 gap-sm-3">
                                    <input class="form-check-input radio--input radio--input_lg switcher-input-js" type="radio" name="custom_sorting_status" value="0" data-parent-class="top-vendor" data-from="default-sorting"
                            ...
                            <div class="col-xl-6 col-md-6">
                                <div class="form-check d-flex gap-2 gap-sm-3">
                                    <input class="form-check-input radio--input radio--input_lg switcher-input-js" type="radio" name="custom_sorting_status" value="1" data-parent-class="top-vendor" data-from="custom-sorting"
                        ...
                        <div class="d-flex flex-column gap-20">
                            <div class="d-flex flex-column gap-3 gap-sm-4 border rounded-10 bg-white p-12 p-sm-20">
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="minimum_rating_point" value="4" id="top-vendor-minimum-rating-4"
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show"  name="minimum_rating_point" value="3.5" id="top-vendor-minimum-rating-3-5"
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="minimum_rating_point" id="top-vendor-minimum-rating-2" value="2"
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="minimum_rating_point" id="top-vendor-minimum-rating-0" value="default"
                            ...
                            <div class="d-flex flex-column gap-3 gap-sm-4 border rounded-10 bg-white p-12 p-sm-20">
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="sort_by" value="order" id="top-vendor-sort-by-order"
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="sort_by" value="reviews_count" id="top-vendor-sort-by-reviews-count"
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="sort_by" id="top-vendor-sort-by-ratings" value="default"
                            ...
                            <div class="d-flex flex-column gap-3 gap-sm-4 border rounded-10 bg-white p-12 p-sm-20">
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show"name="vacation_mode_sorting" value="desc" data-parent-class="top-vendor" id="top-vendor-vacation-mode-last"
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="vacation_mode_sorting" value="hide" data-parent-class="top-vendor" id="top-vendor-vacation-mode-remove"
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="vacation_mode_sorting" value="default" data-parent-class="top-vendor" id="top-vendor-vacation-mode-default"
                            ...
                            <div class="d-flex flex-column gap-3 gap-sm-4 border rounded-10 bg-white p-12 p-sm-20">
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="temporary_close_sorting" value="desc" data-parent-class="top-vendor" id="top-vendor-temporary-close-last"
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="temporary_close_sorting" value="hide" data-parent-class="top-vendor" id="top-vendor-temporary-close-remove"
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="temporary_close_sorting" value="default" data-parent-class="top-vendor" id="top-vendor-temporary-close-default"
