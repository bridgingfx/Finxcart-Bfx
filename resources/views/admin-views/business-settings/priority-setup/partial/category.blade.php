<div class="card mt-2 category">
    <div class="card-body">
        ...
        <div class="p-12 p-sm-20 bg-section rounded">
            <form action="{{route('admin.business-settings.priority-setup.index',['type'=>'category'])}}" method="post" novalidate>
                @csrf
                        ...
                        <div class="row g-4">
                            <div class="col-xl-6 col-md-6">
                                <div class="form-check d-flex gap-2 gap-sm-3">
                                    <input class="form-check-input radio--input radio--input_lg switcher-input-js" type="radio" name="custom_sorting_status" value="0" data-parent-class="category" data-from="default-sorting" {{ $categoryPriority?->custom_sorting_status == 1 ? '' : 'checked' }}>
                            ...
                            <div class="col-xl-6 col-md-6">
                                <div class="form-check d-flex gap-2 gap-sm-3">
                                    <input class="form-check-input radio--input radio--input_lg switcher-input-js" type="radio" name="custom_sorting_status" value="1" data-parent-class="category" data-from="custom-sorting"
                        ...
                        <div class="d-flex flex-column gap-20">
                            <div class="d-flex flex-column gap-3 gap-sm-4 border rounded-10 bg-white p-12 p-sm-20">
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="sort_by"
