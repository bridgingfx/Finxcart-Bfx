<div class="card mt-2 brand">
    <div class="card-body">
        ...
        <div class="p-12 p-sm-20 bg-section rounded">
            <form action="{{route('admin.business-settings.priority-setup.index',['type'=>'brand'])}}" method="post" novalidate>
                @csrf
                        ...
                        <div class="row g-4">
                            <div class="col-xl-6 col-md-6">
                                <div class="form-check d-flex gap-2 gap-sm-3">
                                    <input class="form-check-input radio--input radio--input_lg switcher-input-js" type="radio" name="custom_sorting_status" value="0" data-parent-class="brand" data-from="default-sorting" {{ $brandPriority?->custom_sorting_status == 1 ? '' : 'checked' }}>
                            ...
                            <div class="col-xl-6 col-md-6">
                                <div class="form-check d-flex gap-2 gap-sm-3">
                                    <input class="form-check-input radio--input radio--input_lg switcher-input-js" type="radio" name="custom_sorting_status" value="1" data-parent-class="brand" data-from="custom-sorting"
