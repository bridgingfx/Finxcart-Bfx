<div class="card mt-2 vendor-list">
    <div class="card-body">
        ...
        <div class="p-12 p-sm-20 bg-section rounded">
            <form action="{{route('admin.business-settings.priority-setup.index',['type'=>'vendor_list'])}}" method="post" novalidate>
                @csrf
                        ...
                        <div class="row g-4">
                            <div class="col-xl-6 col-md-6">
                                <div class="form-check d-flex gap-2 gap-sm-3">
                                    <input class="form-check-input radio--input radio--input_lg switcher-input-js" type="radio" name="custom_sorting_status" value="0" data-parent-class="vendor-list" data-from="default-sorting"
                            ...
                            <div class="col-xl-6 col-md-6">
                                <div class="form-check d-flex gap-2 gap-sm-3">
                                    <input class="form-check-input radio--input radio--input_lg switcher-input-js" type="radio" name="custom_sorting_status" value="1" data-parent-class="vendor-list" data-from="custom-sorting"
                        ...
                        <div class="d-flex flex-column gap-20">
                            <div class="d-flex flex-column gap-3 gap-sm-4 border rounded-10 bg-white p-12 p-sm-20">
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="sort_by" value="latest_created" id="vendor-list-sort-by-latest-created"
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="sort_by" value="first_created" id="vendor-list-sort-by-first-created"
                            ...
                            <div class="d-flex flex-column gap-3 gap-sm-4 border rounded-10 bg-white p-12 p-sm-20">
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="vacation_mode_sorting" value="desc" data-parent-class="vendor-list" id="vendor-list-vacation-mode-last"
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="vacation_mode_sorting" value="hide" data-parent-class="vendor-list" id="vendor-list-vacation-mode-remove"
                            ...
                            <div class="d-flex flex-column gap-3 gap-sm-4 border rounded-10 bg-white p-12 p-sm-20">
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="temporary_close_sorting" value="desc" data-parent-class="vendor-list" id="vendor-list-temporary-close-last"
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="temporary_close_sorting" value="hide" data-parent-class="vendor-list" id="vendor-list-temporary-close-remove"
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="temporary_close_sorting" value="default" data-parent-class="vendor-list" id="vendor-list-temporary-close-default"
