<div class="card mt-2 new-arrival-product">
    <div class="card-body">
        ...
        <div class="p-12 p-sm-20 bg-section rounded">
            <form action="{{ route('admin.business-settings.priority-setup.index', ['type' => 'new_arrival_product_list']) }}"
                        ...
                        <div class="row g-4">
                            <div class="col-xl-6 col-md-6">
                                <div class="form-check d-flex gap-2 gap-sm-3">
                                    <input class="form-check-input radio--input radio--input_lg switcher-input-js" name="custom_sorting_status" value="0"
                            ...
                            <div class="col-xl-6 col-md-6">
                                <div class="form-check d-flex gap-2 gap-sm-3">
                                    <input class="form-check-input radio--input radio--input_lg switcher-input-js"
                                        type="radio" name="custom_sorting_status" value="1"
                    ...
                    <div
                        ...
                        <div class="d-flex flex-column gap-20">
                            <div>
                                ...
                                <p class="mb-0">{{ translate('products_are_considered_as') }} <span class="fw-semibold">{{ translate('New_Arrival') }}</span>, {{ translate('if_it_is_added_with_in_x_days_months') }}</p>
                                <div class="input-group mt-2">
                                    ...
                                    <div class="input-group-append select-wrapper">
                                        <select class="form-select shadow-none" name="duration_type">
                                            <option value="days"
