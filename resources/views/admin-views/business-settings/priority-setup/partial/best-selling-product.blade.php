<div class="card mt-2 best-selling-product">
    <div class="card-body">
        ...
        <div class="p-12 p-sm-20 bg-section rounded">
            <form action="{{route('admin.business-settings.priority-setup.index',['type'=>'best_selling_product_list'])}}" method="post" novalidate>
                @csrf
                        ...
                        <div class="row g-4">
                            <div class="col-xl-6 col-md-6">
                                <div class="form-check d-flex gap-2 gap-sm-3">
                                    <input class="form-check-input radio--input radio--input_lg switcher-input-js" type="radio" data-parent-class="best-selling-product" data-from="default-sorting" name="custom_sorting_status" value="0"
                            ...
                            <div class="col-xl-6 col-md-6">
                                <div class="form-check d-flex gap-2 gap-sm-3">
                                    <input class="form-check-input radio--input radio--input_lg switcher-input-js" type="radio" name="custom_sorting_status" value="1" data-parent-class="best-selling-product" data-from="custom-sorting"
                        ...
                        <div class="d-flex flex-column gap-20">
                            <div class="d-flex flex-column gap-3 gap-sm-4 border rounded-10 bg-white p-12 p-sm-20">
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="sort_by" value="most_order" id="best-selling-product-sort-by-most-order"
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="sort_by" value="reviews_count" id="best-selling-product-sort-by-reviews-count"
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="sort_by" value="rating" id="best-selling-product-sort-by-ratings"
                            ...
                            <div class="d-flex flex-column gap-3 gap-sm-4 border rounded-10 bg-white p-12 p-sm-20">
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="out_of_stock_product" value="desc" data-parent-class="best-selling-product" id="best-selling-product-stock-out-remove"
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="out_of_stock_product" value="hide" data-parent-class="best-selling-product" id="best-selling-product-stock-out-last"
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="out_of_stock_product" value="default" data-parent-class="best-selling-product" id="best-selling-product-stock-out-default"
                            ...
                            <div class="d-flex flex-column gap-3 gap-sm-4 border rounded-10 bg-white p-12 p-sm-20">
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="temporary_close_sorting" value="desc" data-parent-class="best-selling-product" id="best-selling-product-temporary-close-last"
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="temporary_close_sorting" value="hide" data-parent-class="best-selling-product" id="best-selling-product-temporary-close-remove"
                                ...
                                <div class="form-check d-flex gap-1">
                                    <input type="radio" class="form-check-input radio--input show" name="temporary_close_sorting" value="default" data-parent-class="best-selling-product" id="best-selling-product-temporary-close-default"
