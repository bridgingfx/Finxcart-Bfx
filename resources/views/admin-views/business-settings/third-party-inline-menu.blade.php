<div class="inline-page-menu my-4">
    <ul class="list-unstyled">
        ...
        <li class="{{ Request::is('admin/third-party/firebase-configuration/authentication') ?'active':'' }}">
            <a href="{{route('admin.third-party.firebase-configuration.authentication')}}"
