<div class="card">
    <div class="card-body">
        <div class="d-flex flex-column gap-3 gap-sm-20">
            ...
            <form action="{{route('admin.pages-and-media.vendor-registration-reason.add')}}" method="post" novalidate>
                @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center">
                                                <form action="{{route('admin.pages-and-media.vendor-registration-reason.update-status')}}"
                                                    id="update-reason-status{{$reason['id']}}-form"
                                                    class="no-reload-form" method="post" enctype="multipart/form-data" novalidate>
                                                    @csrf
