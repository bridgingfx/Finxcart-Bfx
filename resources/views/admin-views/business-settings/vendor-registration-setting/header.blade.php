...
@section('content')
    <div class="content container-fluid">
        ...
        <form action="{{route('admin.pages-and-media.vendor-registration-settings.index')}}" method="post" enctype="multipart/form-data" novalidate>
            @csrf
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="col-lg-8">
                            <div class="p-12 p-sm-20 bg-section rounded h-100">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="title" rows="1" placeholder="{{translate('enter_title')}}" data-maxlength="50" required>{{$vendorRegistrationHeader?->title}}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control text-capitalize" name="sub_title" rows="1" placeholder="{{translate('enter_sub_title')}}" data-maxlength="50" required>{{$vendorRegistrationHeader?->sub_title}}</textarea>
                                    <div class="d-flex justify-content-end">
