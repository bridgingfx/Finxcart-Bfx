<form action="{{ route('admin.pages-and-media.vendor-registration-reason.update', ['id'=>$vendorRegistrationReason['id']]) }}" method="post" id="update-form-submit" novalidate>
    @csrf
            ...
            <div class="mb-3 mb-sm-20">
                <div class="p-12 p-sm-20 bg-section rounded">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea class="form-control" name="description"  rows="4" placeholder="{{translate('write_description').'...'}}" data-maxlength="150" required>{{ $vendorRegistrationReason['description'] }}</textarea>
                        <div class="d-flex justify-content-end">
                    ...
                    <div class="form-group">
                        ...
                        <div class="select-wrapper">
                            <select name="priority" class="form-select bg-white" required>
...
<form action="{{ route('admin.pages-and-media.vendor-registration-reason.delete') }}" method="post" novalidate>
