<form action="{{ route('admin.helpTopic.update', ['id'=>$help['id']]) }}" method="post" enctype="multipart/form-data" novalidate>
    @csrf
...
<form action="{{ route('admin.helpTopic.delete') }}" method="post" novalidate>
