                    ...
                    <div class="col-md-3">
                        <div class="d-flex justify-content-between align-items-center gap-3 rounded px-20 py-3 user-select-none bg-section">
                            ...
                            <form action="{{ route('admin.helpTopic.feature-status-update') }}" method="post"
                                  id="vendor-registration-faq-status-form" class="no-reload-form" novalidate>
                                @csrf
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-column gap-3 gap-sm-20">
                    ...
                    <form action="{{ route('admin.helpTopic.add-new') }}" method="post" enctype="multipart/form-data" novalidate>
                        @csrf
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="select-wrapper">
                                            <select name="ranking" class="form-select bg-white" required>
                                        ...
                                        <tr id="data-{{$help['id']}}">
                                            ...
                                            <td class="text-center">
                                                <form action="{{ route('admin.helpTopic.status', ['id'=>$help['id']])}}"
                                                    ...
                                                    class="helpTopic_status_form no-reload-form" novalidate>
                                                    @csrf
