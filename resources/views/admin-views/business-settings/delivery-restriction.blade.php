                    ...
                    <div class="card-body">
                        <div class="d-flex flex-column gap-20">
                            <div class="d-flex justify-content-between align-items-start gap-3 user-select-none">
                                ...
                                <form action="{{ route('admin.business-settings.delivery-restriction.country-restriction-status-change') }}" method="post" id="delivery-available-country-status-form" class="no-reload-form" novalidate>
                                    @csrf
                            ...
                            <div class="p-20 bg-section rounded">
                                <form action="{{ route('admin.business-settings.delivery-restriction.add-delivery-country') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select multiple-select2" name="country_code[]"
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column gap-20">
                                        <div class="d-flex justify-content-between align-items-center gap-20 flex-wrap">
                                            ...
                                            <form action="{{ route('admin.business-settings.delivery-restriction.index') }}" method="get" novalidate>
                                                @csrf
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex justify-content-center gap-2">
                                                                    ...
                                                                    <form action="{{ route('admin.business-settings.delivery-restriction.delivery-country-delete', ['id' => $storedCountry->id]) }}" method="post" id="country-{{ $storedCountry->id }}" novalidate>
                                                                        @csrf @method('delete')
                                                                    </form>
                                                                </div>
                                                            </td>
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-column gap-20">
                            <div class="d-flex justify-content-between align-items-start gap-3 user-select-none">
                                ...
                                <form action="{{ route('admin.business-settings.delivery-restriction.zipcode-restriction-status-change') }}"
                                    method="post" id="delivery-available-zip-code-status-form" class="no-reload-form" novalidate>
                                    @csrf
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex justify-content-center gap-2">
                                                                    ...
                                                                    <form action="{{ route('admin.business-settings.delivery-restriction.zip-code-delete', ['id' => $zip->id]) }}"
                                                                        method="post" id="zip-{{ $zip->id }}" novalidate>
                                                                        @csrf @method('delete')
                                                                    </form>
                                                                </div>
                                                            </td>
