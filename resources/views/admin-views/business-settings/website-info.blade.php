                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="tel" name="company_phone" required
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" id="country" name="country_code" required
                                        ...
                                        <div class="col-xl-4 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number"
                                                    ...
                                                    name="decimal_point_settings" class="form-control" min="0" required
                                    ...
                                    <div class="row gy-3">
                                        <div class="col-xl-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="company_copyright_text" rows="2" placeholder="{{ translate('Type_about_the_description') }}" data-maxlength="100" required>{{ $businessSetting['company_copyright_text'] }}</textarea>
                                        ...
                                        <div class="col-xl-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control"   name="cookie_text" rows="2" placeholder="{{ translate('type_about_the_description') }}" data-maxlength="100" required>{{ isset($cookieSetting) ? $cookieSetting['cookie_text'] : ''}}</textarea>
                                                <div class="d-flex justify-content-end">
