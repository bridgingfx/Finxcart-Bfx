<div>
    <div class="text-center">
        <img width="100" class="mb-4" id="view-mail-icon"
             src="{{ $template->logo_full_url['path'] ?? dynamicAsset(path: 'public/assets/back-end/img/email-template/congratulations.png')}}"
             alt="">
    ...
    <div class="main-table-inner mb-4">
        <div class="d-flex justify-content-center pt-3">
            <img width="76" class="mb-4 mx-auto" id="view-mail-logo" src="{{ $template->logo_full_url['path'] ?? $companyLogoUrl ?? getStorageImages(path: $companyLogo, type:'backend-logo')}}" alt="">
        </div>
        <div class="text-center">
