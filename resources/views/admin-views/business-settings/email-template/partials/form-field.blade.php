...
@endphp
    ...
    <div class="d-flex flex-column gap-20 bg-section p-12 p-sm-20">
        ...
        <div class="upload-file">
            <input type="file" class="upload-file__input single_file_input"
                name="logo" id="mail-logo" data-image-id="view-mail-icon"
                accept=".webp, .png"  value="" {{ $template->logo_full_url['path'] ? '' : 'required' }} >
            <label
    ...
    <div class="d-flex flex-column gap-20 bg-section p-12 p-sm-20">
        <div>
            <label for="mail-icon" class="form-label fw-semibold mb-1">
                {{translate('Icon')}}
            </label>
        ...
        <div class="upload-file">
            <input type="file"class="upload-file__input single_file_input"
                name="icon" id="mail-icon" data-image-id="view-mail-logo"
                accept=".webp, .png"  value="" {{ $template->image_full_url['path'] ? '' : 'required' }}>
            <label
                class="upload-file__wrapper ratio-3-1">
                <div class="upload-file-textbox text-center">
                    <div class="d-flex gap-2 align-items-center justify-content-center flex-wrap">
                ...
                <img class="upload-file-img" loading="lazy" src="{{$template->image_full_url['path'] ?? ''}}" data-default-src="" alt="">
            </label>
            <div class="overlay">
                <div class="d-flex gap-10 justify-content-center align-items-center h-100">
                    <button type="button" class="btn btn-outline-info icon-btn edit_btn">
