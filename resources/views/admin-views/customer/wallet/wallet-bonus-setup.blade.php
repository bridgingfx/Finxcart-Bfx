...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.customer.wallet.bonus-setup') }}" id="form-submit" method="post" novalidate>
                    @csrf
                    <div class="row g-3">
                    ...
                    <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                        ...
                        @foreach ($data as $key=>$item)
                            <tr>
                                ...
                                <td>
                                    <form action="{{route('admin.customer.wallet.bonus-setup-status')}}" method="post" id="bonus-setup-{{ $item->id }}-form" class="no-reload-form" novalidate>
                                        @csrf
                                ...
                                <td>
                                    ...
                                    <form action="{{route('admin.customer.wallet.bonus-setup-delete',['id'=>$item['id']])}}"
                                          method="post" id="wallet-bonus-{{$item['id']}}" novalidate>
                                        @csrf @method('delete')
                                    </form>
                                </td>
                            </tr>
