                        ...
                        @foreach($customers as $key=>$customer)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="text-muted fs-12">{{ $customer->created_at?->format('h:i A') }}</div>
                                </td>
                                <td>
                                    ...
                                    @else
                                        <form action="{{route('admin.customer.status-update')}}" method="post"
                                            id="customer-status{{$customer['id']}}-form" class="no-reload-form" novalidate>
                                            @csrf
                                ...
                                <td>
                                    ...
                                    <form action="{{route('admin.customer.delete',[$customer['id']])}}"
                                        method="post" id="customer-{{$customer['id']}}" novalidate>
                                        @csrf @method('delete')
                                    </form>
                                </td>
                            </tr>
