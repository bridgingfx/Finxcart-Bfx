        ...
        <div class="card border h-100">
            <div class="card-body d-flex flex-wrap gap-2 justify-content-between h-100">
                <div class="item d-flex flex-column gap-2 flex-grow-1">
                    ...
                    <label class="form-check d-flex gap-2">
                        <input type="checkbox" name="meta_no_follow" value="1" {{ !empty($product?->seoInfo?->no_follow) ? 'checked' : '' }} class="input-no-index-sub-element form-check-input checkbox--input">
                    ...
                    <label class="form-check d-flex gap-2">
                        <input type="checkbox" name="meta_no_image_index" value="1" {{ $product?->seoInfo?->no_image_index ? 'checked' : '' }} class="input-no-index-sub-element form-check-input checkbox--input">
                ...
                <div class="item d-flex flex-column gap-2 flex-grow-1">
                    ...
                    <label class="form-check d-flex gap-2">
                        <input type="checkbox" name="meta_no_archive" value="1" {{ $product?->seoInfo?->no_archive ? 'checked' : '' }} class="input-no-index-sub-element form-check-input checkbox--input">
                    ...
                    <label class="form-check d-flex gap-2">
                        <input type="checkbox" name="meta_no_snippet" value="1" {{ $product?->seoInfo?->no_snippet ? 'checked' : '' }} class="input-no-index-sub-element form-check-input checkbox--input">
        ...
        <div class="card border h-100">
            <div class="card-body d-flex flex-column gap-2 h-100">
                <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center">
                    <div class="item">
                        <label class="form-check d-flex gap-2">
                            <input type="checkbox" name="meta_max_snippet" value="1" {{ $product?->seoInfo?->max_snippet ? 'checked' : '' }} class="form-check-input checkbox--input">
                            <span class="user-select-none form-check-label">
                ...
                <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center">
                    <div class="item">
                        <label class="form-check d-flex gap-2 m-0">
                            <input type="checkbox" name="meta_max_video_preview" value="1" {{ $product?->seoInfo?->max_video_preview ? 'checked' : '' }} class="form-check-input checkbox--input">
                            <span class="user-select-none form-check-label">
                ...
                <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center">
                    <div class="item">
                        <label class="form-check d-flex gap-2 m-0">
                            <input type="checkbox" name="meta_max_image_preview" value="1" {{ $product?->seoInfo?->max_image_preview ? 'checked' : '' }} class="form-check-input checkbox--input">
