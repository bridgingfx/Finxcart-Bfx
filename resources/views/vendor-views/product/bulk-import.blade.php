                                    ...
                                    <div class="col-auto">
                                        ...
                                        <div class="uploadDnD">
                                            <div class="form-group inputDnD input_image input_image_edit" data-title="{{translate('drag_&_drop_file_or_browse_file')}}">
                                                <input type="file" name="products_file" accept=".xlsx, .xls" class="form-control-file text--primary font-weight-bold action-upload-section-dot-area" id="inputFile" required>
                                            </div>
                                        </div>
...
@push('script')
    <script>
        ...
        // presence check.
        $(document).on('submit', 'form:has(input[name="products_file"][required])', function (e) {
            let $file = $(this).find('input[name="products_file"]');
            let input = $file[0];
