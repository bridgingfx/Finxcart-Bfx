...
@section('content')
    <div class="content container-fluid">
                    ...
                    @if(isset($lastChatUser))
                        <div
                            ...
                            @if(Request::is('vendor/messages/index/customer'))
                                <div class="dropdown">
                                    <a class="text--title" href="javascript:" role="button"
                                       id="viewDetailsDropdown"
                                       data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <img width="25" class="svg"
                                             src="{{dynamicAsset(path: 'public/assets/back-end/img/icons/dots.svg')}}"
                                             alt="">
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-right shadow-lg border p-3 w-0"
                                        ...
                                        <a class="dropdown-item bg-transparent p-0 text-center font-weight-medium user-details-route"
                                           href="{{ Request::is('vendor/messages/index/customer') ? route('vendor.orders.list', ['status' => 'all', 'filter' => 'all', 'customer_id' => $lastChatUser->id]) : '#' }}">
                                            View details
                                        </a>
                                    </div>
                                </div>
        ...
        <span id="chatting-typing-url"
              data-url="{{ Request::is('vendor/messages/index/customer') ? route('vendor.messages.typing').'?user_id=' : route('vendor.messages.typing').'?delivery_man_id=' }}"></span>
        <span id="chatting-typing-status-url"
              data-url="{{ Request::is('vendor/messages/index/customer') ? route('vendor.messages.typing-status').'?user_id=' : route('vendor.messages.typing-status').'?delivery_man_id=' }}"></span>
