...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-body">
                <form action="{{route('vendor.shop.close-shop-temporary',[$shop['id']])}}" method="POST"  id="temporary-close-form" data-from="shop" novalidate>
                    @csrf
        ...
        <div class="modal fade" id="vacation-mode-modal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content text-start">
                    <form action="{{route('vendor.shop.update-vacation', [$shop['id']])}}" method="post" novalidate>
                        @csrf
