    ...
    <div class="content container-fluid">
        ...
        <div id="order_wise_shipping">
            <div class="card mt-2">
                ...
                <div class="card-body">
                    <form action="{{route('vendor.business-settings.shipping-method.index')}}" method="post" novalidate>
                        @csrf
                        <div class="row">
                    ...
                    <table id="datatable"
                        ...
                        @foreach($shippingMethods as $k=>$method)
                            <tr>
                                ...
                                <td>
                                    <form action="{{route('vendor.business-settings.shipping-method.update-status')}}" method="post" id="shipping-methods{{$method['id']}}-form" class="shipping_methods_form" novalidate>
                                        @csrf
        ...
        <div class="card mt-2" id="update_category_shipping_cost">
            ...
            <div class="card-body px-0">
                <div class="table-responsive">
                    <form action="{{route('vendor.business-settings.category-wise-shipping-cost.index')}}" method="POST" novalidate>
                        @csrf
