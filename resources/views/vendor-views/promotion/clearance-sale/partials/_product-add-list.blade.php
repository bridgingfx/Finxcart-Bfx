            ...
            <div class="d-flex flex-wrap justify-content-end gap-3">
                ...
                @if(count($stockClearanceProduct) > 0)
                    ...
                    <form action="{{ route('vendor.clearance-sale.clearance-delete-all-product') }}"
                          method="post" id="clearance-product" novalidate>
                        @csrf @method('delete')
                    </form>
                @endif
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-center">
                                    <form action="{{ route('vendor.clearance-sale.product-status-update') }}" data-from="clearance-sale"
                                          method="post" id="clearance-sale-product-status{{ $clearanceProduct['id'] }}-form" data-id="clearance-sale-product-status-form" novalidate>
                                        @csrf
                            ...
                            <td>
                                ...
                                <form action="{{ route('vendor.clearance-sale.clearance-delete',[$clearanceProduct->product_id]) }}"
                                      method="post" id="clearance-product-{{ $clearanceProduct->id}}" novalidate>
                                    @csrf @method('delete')
                                </form>
                            </td>
                        </tr>
