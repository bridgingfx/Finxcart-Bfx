...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <form action="{{route('vendor.delivery-man.emergency-contact.index')}}" method="post" novalidate>
                    @csrf
                    <div class="card">
                        <div class="card-body">
                        ...
                        <table id="datatable" class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table w-100 text-left">
                            ...
                            @foreach($contacts as $contact)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{route('vendor.delivery-man.emergency-contact.index')}}" method="post" id="contact_status{{$contact['id']}}-form" class="contact_status_form" novalidate>
                                            @csrf @method('patch')
