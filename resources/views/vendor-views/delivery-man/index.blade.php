...
@section('content')
    <div class="content container-fluid">
        ...
        <form action="{{route('vendor.delivery-man.index')}}" method="post" enctype="multipart/form-data" id="add-delivery-man-form" novalidate>
            @csrf
            <div class="card mb-3">
                <div class="card-body">
                    <div class="row">
...
@push('script_2')
    ...
    <script>
        ...
        window.formValidators['add-delivery-man-form'] = function () {
            let isValid = true;
