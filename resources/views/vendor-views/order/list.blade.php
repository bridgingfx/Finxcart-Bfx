                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="title-color hover-c1"
                                       href="{{route('vendor.orders.details',$order['id'])}}">{{ $order->parent_order_id ? $order->parent_order_id.'-'.$order->child_number : $order['id'] }} {!! $order->order_type == 'POS' ? '<span class="text--primary">(POS)</span>' : '' !!}</a>
                                </td>
                                <td>
