        ...
        <div class="auth-wrapper-right">
            <div class="auth-wrapper-form">
                <div>
                    ...
                    <form class="needs-validation forget-password-form" novalidate method="POST" action="{{ route('vendor.auth.forgot-password.reset-password') }}">
                            @csrf

                        <div class="py-2 mt-4">
                            <div class="form-group d-none">
                                <input type="text" name="reset_token" value="{{$token}}">
                            </div>
