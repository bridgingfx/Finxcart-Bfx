...
<main id="content" role="main" class="main">
    <div class="auth-wrapper">
        <div class="auth-wrapper-left" style="background: url('{{ dynamicAsset(path: 'public/assets/back-end/img/login_page_banner.png') }}') no-repeat center center / cover">
        ...
        <div class="auth-wrapper-right">
            <div class="auth-wrapper-form">
                ...
                <form id="form-id" action="{{route('vendor.auth.login')}}" method="post" id="admin-login-form" novalidate>
                    @csrf
                    <div>
                        <div class="mb-4">
                    ...
                    <p class="text-center mt-3 mb-0" style="font-size:14px;color:#6b7280;">
                        ...
                        <a href="{{ route('vendor.auth.registration.index') }}" style="font-weight:600;">
