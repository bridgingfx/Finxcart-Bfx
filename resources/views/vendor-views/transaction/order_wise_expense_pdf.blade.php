...
<?php
    ...
    $couponExpense = $transaction->coupon_discount_bearer == 'seller' ? $transaction->discount_amount : 0;
    $freeDeliveryExpense = $transaction->free_delivery_bearer == 'seller' ? $transaction->extra_discount : 0;
    $commissionExpense = $transaction->admin_commission ?? 0;
    $totalExpense = $couponExpense + $freeDeliveryExpense + $commissionExpense;
?>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="p-0 p-3">:
                                    ...
                                    {{ $commissionExpense > 0 ? translate('platform_commission') : '' }}
                                </td>
                            </tr>
                        </table>
                    </td>
        ...
        <td class="pt-0">
            <table class="bs-0 __product-table inter">
                ...
                <tr>
                    ...
                    <td class="text-right">
                        {{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $couponExpense), currencyCode: getCurrencyCode()) }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="text-right">
                        {{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $freeDeliveryExpense), currencyCode: getCurrencyCode()) }}
                    </td>
                </tr>
                <tr>
                    <td class="text-center">3</td>
                    <td>{{translate('platform_commission')}}</td>
                    <td class="text-right">
                        {{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $commissionExpense), currencyCode: getCurrencyCode()) }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="text-right">
                        {{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $totalExpense), currencyCode: getCurrencyCode()) }}
                    </td>
                </tr>
                </tbody>
            </table>
