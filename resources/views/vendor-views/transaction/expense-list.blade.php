        ...
        <div class="store-report-content mb-2">
            <div class="left-content expense--content">
                ...
                <div class="left-content-card">
                    <img src="{{dynamicAsset(path: '/public/assets/back-end/img/expense.svg')}}" alt="">
                    <div class="info">
                        <h4 class="subtitle">{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $commission_expense), currencyCode: getCurrencyCode()) }}</h4>
                        <h6 class="subtext">{{translate('platform_commission')}}</h6>
                    </div>
                </div>
                <div class="left-content-card">
                ...
                <div class="table-responsive">
                    <table id="datatable"
                        ...
                        @foreach($expense_transactions_table as $key=>$transaction)
                            @php($couponExpense = $transaction->coupon_discount_bearer == 'seller' ? $transaction->discount_amount : 0)
                            @php($freeDeliveryExpense = $transaction->free_delivery_bearer == 'seller' ? $transaction->extra_discount : 0)
                            @php($commissionExpense = $transaction->admin_commission ?? 0)
