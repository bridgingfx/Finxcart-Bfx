...
<script src="{{ dynamicAsset(path: 'public/assets/new/back-end/libs/intl-tel-input/js/intlTelInput.js') }}"></script>
<script src="{{ dynamicAsset(path: 'public/assets/new/back-end/libs/intl-tel-input/js/utils.js') }}"></script>
<script
    src="{{ dynamicAsset(path: 'public/assets/new/back-end/libs/intl-tel-input/js/country-picker-init.js') }}"></script>
...
<script
    src="{{ dynamicAsset(path: 'public/assets/new/back-end/libs/spartan-multi-image-picker/spartan-multi-image-picker-min.js') }}"></script>
...
<script src="{{ dynamicAsset(path: 'public/assets/new/back-end/js/intlTelInout-validation.js') }}"></script>
...
<script src="{{ dynamicAsset(path: 'public/assets/new/back-end/js/form-validation-core.js') }}"></script>
...
@if(session('success'))
    <script>'use strict'; toastMagic.success('{{ addslashes(session('success')) }}');</script>
@endif
@if(session('error'))
    <script>'use strict'; toastMagic.error('{{ addslashes(session('error')) }}');</script>
@endif
