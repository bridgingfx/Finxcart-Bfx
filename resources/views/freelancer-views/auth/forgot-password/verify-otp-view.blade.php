        ...
        <div class="auth-wrapper-right">
            <div class="auth-wrapper-form text-center">
                <div class="__inline-20">
                    ...
                    <div class="mb-4">
                        <h1 class="h2 mb-2">{{ translate('Verify_OTP').'?' }}</h1>
                        <h1 class="h5 text-gray-900 fw-normal mb-0">
                            {{ translate('provide_your_otp_and_proceed') }}
                        </h1>
                    </div>

                    <form id="form-id" action="{{route('freelancer.auth.forgot-password.otp-verification')}}" method="post"
                          id="admin-login-form" novalidate>
                        @csrf
                        ...
                        <div class="d-flex justify-content-center align-items-baseline flex-wrap gap-2">
                            <a class="btn btn-lg btn-block btn-secondary w-auto flex-grow-1" href="{{ route('freelancer.auth.forgot-password.index') }}">
                                {{ translate('back')}}
                            </a>
