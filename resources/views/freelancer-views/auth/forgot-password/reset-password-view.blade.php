...
<head>
    ...
    <title>{{ translate('freelancer') }} | {{ translate('reset_Password') }}</title>
        ...
        <div class="auth-wrapper-right">
            <div class="auth-wrapper-form">
                <div>
                    ...
                    <div class="mb-4">
                        <h1 class="h2 mb-2">{{ translate('Reset_your_password').'?' }}</h1>
                    ...
                    <form class="needs-validation forget-password-form" novalidate method="POST" action="{{ route('freelancer.auth.forgot-password.reset-password') }}">
                            @csrf
