            ...
            <div class="modal-body d-flex flex-column gap-3">
                ...
                <div class="border rounded bg-white">
                    <div class="p-3 fs-12 d-flex flex-column gap-2">
                        ...
                        <div class="d-flex justify-content-between gap-2">
                            <div class="text-muted">{{ translate('vat_tax') }}</div>
                        ...
                        $coupon_discount = $total_product_price > 0 ? ($order->discount_amount * $subtotal) / $total_product_price : 0;
                ...
                <form action="{{route('refund-store')}}" method="post" enctype="multipart/form-data" novalidate>
                    @csrf
