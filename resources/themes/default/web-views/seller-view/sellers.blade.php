        ...
        <div class="bg-primary-light rounded-10 my-4 p-3 p-sm-4" data-bg-img="{{ theme_asset(path: 'public/assets/front-end/img/media/bg.png') }}">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-lg-4 col-md-6">
                    <form action="{{ route('vendors') }}" method="get" novalidate>
                        @if(request('filter'))
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12 px-2 pb-4 text-center">
                                <a href="{{route('shopView',['id' => $vendorItem['id']])}}" class="others-store-card text-capitalize">
                                    ...
                                    <div class="name-area">
                                        ...
                                        <div class="info pt-2">
                                            <h5 class="text-start d-flex align-items-center flex-wrap gap-1">
                                                {{ $vendorItem['name'] }}
                                                @if(($vendorItem['id'] ?? 0) != 0 && ($vendorItem['seller_id'] ?? 0) && (isset($featuredSellerIds) && $featuredSellerIds->contains($vendorItem['seller_id'])))
                                                    <span class="badge bg-warning text-dark fs-11 fw-semibold px-2 py-1">
                                                        <i class="tio-star"></i> {{ translate('Featured_Vendor') }}
                                                    </span>
                                                @endif
                                            </h5>
