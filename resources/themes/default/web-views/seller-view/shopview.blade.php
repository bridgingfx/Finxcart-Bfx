...
@section('content')
    ...
    <div class="container py-4 __inline-67">
        ...
        <form method="POST" action="{{ url()->current() }}" class="product-list-filter" novalidate>
                ...
                <div class="row">
                    ...
                    <section class="col-lg-9">
                        <div class="row" id="ajax-products-view">
                            @include('web-views.products._ajax-products', ['products' => $products, 'isInitialLoad' => true])
                        </div>
                    </section>
                </div>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('messages')}}" method="post" id="shop-view-chat-form" novalidate>
                        @csrf
