    ...
    <script>
        ...
        $('#sign-up-form').submit(function (e) {
            ...
            if (typeof FormValidators !== 'undefined') {
                let isValid = FormValidators.autoValidateForm(this);
                // name="con_password" doesn't match the auto-detected
                // confirm_password/password_confirmation convention.
                if (!FormValidators.passwordsMatch('#su-password', '#su-password-confirm', "{{ translate('The_password_and_confirm_password_must_match') }}")) {
                    isValid = false;
                }
                if (!isValid) {
