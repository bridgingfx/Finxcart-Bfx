                ...
                <div class="card py-2 mt-4">
                    <form class="card-body needs-validation otp-form" action="{{route('customer.auth.otp-verification')}}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="resend_otp_custom text-center {{ $time_count <= 0 ? 'd--none' : ''}}">
                                ...
                                <h6 class="text-primary mb-5 verifyTimer">
                                    <span class="verifyCounter" data-second="{{$time_count}}" data-expires-at="{{ now()->addSeconds($time_count)->getTimestamp() * 1000 }}"></span>s
                                </h6>
                            </div>
                        ...
                        <div class="d-flex flex-wrap justify-content-between align-items-center mt-3">
                            ...
                            <button class="btn p-0 resend-otp-button text-primary" type="button" id="customerOtpVerify" {{ $time_count > 0 ? 'disabled' : '' }}
