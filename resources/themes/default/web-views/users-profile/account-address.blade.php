                        ...
                        <form action="{{ route('address-store') }}" method="post" novalidate>
                            ...
                            <div class="tab-content">
                                <div id="home" class="container tab-pane active"><br>
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input class="form-control phone-input-with-country-picker" id="phone"
                                                type="text" placeholder="{{ translate('enter_phone_number') }}"
                                                required>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <select name="country" id="" class="form-control selectpicker" required
                                                data-live-search="true">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-1">
                                                ...
                                                <span class="fs-14 text-danger font-semi-bold opacity-0 map-address-alert">
                                                    {{ translate('note') }}: {{ translate('yo_need_to_select_address_from_your_selected_country') }}
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-12">
                                            @include('web-views.partials._address-map-search', ['mapQuery' => 'Dubai'])
                                        </div>
                                    </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn--primary">{{ translate('add_information') }}
                                    </button>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="card card-body border-0">
                        <div class="d-flex justify-content-between align-items-center mb-3 gap-2">
                            ...
                            <div class="d-flex justify-content-end align-items-center mb-3 gap-2">
                                <button type="submit"
                                    class="btn btn--primary text-capitalize btn-sm d-flex align-items-center gap-1"
                                    data-toggle="modal" data-target="#exampleModal" id="add_new_address">
                                    <img src="{{ theme_asset(path: 'public/assets/front-end/img/add-address-icon.png') }}"
                                        class="" alt="">
                        ...
                        @if ($shippingAddresses->count() == 0)
                            <div class="text-center text-capitalize pb-5 pt-5">
                                <img class="mb-4"
                                    src="{{ theme_asset(path: 'public/assets/front-end/img/icons/address.svg') }}"
                                    alt="" width="70">
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex justify-content-between gap-2 align-items-center">
                                                <a class="" title="Edit Address" id="edit"
                                                    ...
                                                    <img src="{{ theme_asset(path: 'public/assets/front-end/img/address-edit-icon.png') }}"
                                                        width="19" alt="">
                                                </a>
