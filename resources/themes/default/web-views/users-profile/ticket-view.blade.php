                        ...
                        <form class="needs-validation" href="{{route('support-ticket.comment',[$ticket['id']])}}" enctype="multipart/form-data"
                            ...
                            <div class="d-flex flex-wrap align-items-baseline">
                                <div class="px-2 d-flex">
                                    ...
                                    <div id="file-names-preview" class="text-sm text-muted mt-2"></div>
                                </div>
...
@push('script')
    ...
    <script>
    document.getElementById('f_p_v_up1').addEventListener('change', function () {
        const fileNamesDiv = document.getElementById('file-names-preview');
        ...
        if (this.files.length > 0) {
            for (const file of this.files) {
                ...
                fileNamesDiv.appendChild(nameDiv);
            }
        } else {
