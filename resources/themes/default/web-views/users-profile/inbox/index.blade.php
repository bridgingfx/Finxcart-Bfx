...
@push('css_or_js')
    <style>
        .customer-chat-file-picker { width: 30px; height: 30px; display: inline-flex; align-items: center; justify-content: center; border-radius: 8px; border: 1px solid #e1e9f3; background: #f8fbff; color: #1455AC; }
        .customer-chat-file-picker > svg { display: none; }
        .customer-chat-file-picker i { font-size: 16px; }
    </style>
@endpush
@section('content')
                            ...
                            <div class="chat--sidebar-card h-100">
                                <div class="chat--sidebar-top">
                                    ...
                                    <div class="heading_search px-0">
                                        <form class="rounded bg-white form-inline d-flex justify-content-center md-form form-sm active-cyan-2 mt-2 chatting-search-border" novalidate>
                                            ...
                                            <div class="mesgs">
                                                ...
                                                <div class="type_msg">
                                                    <div class="input_msg_write">
                                                        <form class="d-flex justify-content-center align-items-center md-form form-sm active-cyan-2 chatting-messages-form"
                                                            ...
                                                            <div
                                                                ...
                                                                <label class="py-0 m-0 cursor-pointer customer-chat-file-picker" title="{{ translate('file') }}"><i class="fa fa-paperclip"></i>
    ...
    <span id="chatting-typing-url"
          data-url="{{ Request::is('chat/vendor') ? route('messages.typing').'?vendor_id=' : route('messages.typing').'?delivery_man_id=' }}"></span>
    <span id="chatting-typing-status-url"
          data-url="{{ Request::is('chat/vendor') ? route('messages.typing-status').'?vendor_id=' : route('messages.typing-status').'?delivery_man_id=' }}"></span>
    ...
    <span id="get-video-preview-icon"
          data-video-icon="{{ theme_asset('public/assets/front-end/img/icons/carbon_play-filled.svg') }}"></span>
@endsection
