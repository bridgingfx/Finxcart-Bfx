                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            ...
                            @php $limitReached = $item->limit > 0 && $item->used_count >= $item->limit; @endphp
                            <div class="col-lg-6">
                                <div class="ticket-box" style="{{ $limitReached ? 'opacity:.55;pointer-events:none;position:relative;' : '' }}">
                                @if($limitReached)
                                    <div style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;z-index:2;pointer-events:none;">
                                        <span style="background:rgba(0,0,0,.55);color:#fff;font-size:12px;font-weight:600;padding:4px 10px;border-radius:20px;letter-spacing:.5px;">{{ translate('Already_Used') }}</span>
                                    </div>
                                @endif
