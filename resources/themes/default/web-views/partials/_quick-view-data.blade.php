    ...
    <div class="row ">
                ...
                <div class="cz-product-gallery-icons">
                    <div class="d-flex flex-column">
                        <button type="button" data-product-id="{{ $product['id'] }}"
                            ...
                            <i class="{{($wishlist_status == 1 ? 'fas' : 'far')}} fa-heart wishlist_icon_{{$product['id']}} web-text-primary"
        ...
        <div class="col-lg-7 col-md-8 col-12 mt-md-0 mt-sm-3 web-direction">
            <div class="details __h-100 product-cart-option-container">
                ...
                <br> <span class="font-size-12 text-gray-5">{{ translate('Added_By_BridgingFX') }}</span></div>
                ...
                <form class="mb-2 addToCartDynamicForm add-to-cart-details-form" data-product-type="{{ $product['product_type'] }}" novalidate>
                    ...
                    <div class="mb-3">
                        <div class="product-quantity d-flex flex-column __gap-15">
                            @if($product['product_type'] == 'physical')
                                <div class="product-qty-controls d-none align-items-center gap-3">
                    ...
                    <div
                        ...
                        @if($product->not_sellable)
                            <a href="{{ $product->external_url }}" target="_blank" rel="noopener" class="btn btn--primary string-limit">
                                {{ translate('visit_website') }}
                            </a>
                            <a href="{{ route('products') }}" class="btn btn-outline-primary string-limit product-continue-shopping-btn">
                                {{ translate('continue_shopping') }}
                            </a>
                        @elseif(($product->added_by == 'seller' && ($seller_temporary_close || (isset($product->seller->shop) &&
                        ...
                        @elseif($stockUnderMinimum)
                            ...
                            <button class="btn btn--primary string-limit" type="button" disabled title="{{ translate('stock_is_below_minimum_order_quantity') }}">
                                {{translate('add_to_cart')}}
                            </button>
                            <a href="{{ route('products') }}" class="btn btn-outline-primary string-limit product-continue-shopping-btn">
                                {{ translate('continue_shopping') }}
                        ...
                        @elseif($inCart ?? false)
                            <div class="w-100 mb-2">
                                <span class="badge badge-soft-success border border-success fs-12 px-2 py-1">
                                    <i class="tio-checkmark-circle me-1"></i>{{ translate('This_product_is_already_in_your_cart') }}
                                </span>
                            </div>
                            <button class="btn btn-secondary" type="button" disabled>
                                {{translate('buy_now')}}
                            </button>
                            <a href="{{ route('shop-cart') }}" class="btn btn--primary string-limit">
                        ...
                        <button type="button" data-product-id="{{$product['id']}}"
                            ...
                            <!--   id="wishlist_icon_{{$product['id']}}" aria-hidden="true"></i>-->
                            <i class="fa{{ $wishlist_status == 1 ? 's' : 'r' }} fa-heart wishlist_icon_{{ $product['id'] }} web-text-primary" aria-hidden="true"></i>
