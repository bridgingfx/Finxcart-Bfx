										...
										<div class="js-slide bg-img-hero-center">
											<div class="row height-410-xl py-7 py-md-0 mx-0">
												...
												<div class="col-xl col-6 col-md-6 mt-md-8">
													...
													<div class="mb-4" data-scs-animation-in="fadeInUp" data-scs-animation-delay="300">
														@if(!empty($banner->price))
															<span class="font-size-13">{{ translate('from_2') }}</span>
															<div class="font-size-50 font-weight-bold text-lh-45">
																<sup>$</sup>{{ number_format($banner->price, 2) }}
															</div>
														@endif
													</div>
													@if(!empty($banner->url))
														<a href="{{ $banner->url }}" class="btn btn-primary transition-3d-hover rounded-lg font-weight-normal py-2 px-md-7 px-3 font-size-16"
														data-scs-animation-in="fadeInUp"
														data-scs-animation-delay="400">
															{{ $banner->button_text ?? 'Start Buying' }}
														</a>
													@endif
												</div>
												...
												<div class="col-xl-7 col-6 d-flex align-items-center ml-auto ml-md-0"
													...
													<img class="img-fluid" src="{{ asset('storage/banner/' . $banner->photo) }}" alt="{{ $banner->alt ?? 'Banner Image' }}">
												</div>
											</div>
										</div>
									@endforeach
								...
								<div class="row height-410-xl py-7 py-md-0 mx-0">
									...
									<div class="col-xl col-6 col-md-6 mt-md-8">
										<h1 class="font-size-64 text-lh-57 font-weight-light"
											...
											DISCOVER TOP <span class="d-block font-size-55">{{ translate('fintech') }}</span>
										</h1>
										<h6 class="font-size-15 font-weight-bold mb-3"
											data-scs-animation-in="slideInLeft"
											data-scs-animation-delay="200">FOREX BROKERS, CRYPTO EXCHANGES & MORE
										</h6>
										<div class="mb-4"
											data-scs-animation-in="slideInLeft"
											data-scs-animation-delay="400">
					...
					<div class="overflow-hidden">
						<ul class="list-unstyled row flex-nowrap flex-xl-wrap overflow-auto overflow-lg-visble mx-n2 mx-xl-0 d-xl-block mb-0">
							<li class="px-2 px-xl-0 flex-shrink-0 flex-xl-shrink-1 mb-3">
								<a href="https://transvelo.github.io/electro-html/2.0/html/shop/shop.html" class="min-height-126 max-width-320 py-1 py-xl-2 py-wd-1 banner-bg d-flex align-items-center text-gray-90">
									...
									<div class="col col-lg-6 col-xl-7 col-wd-6 pr-xl-4 pr-wd-3">
										<div class="mb-2 pb-1 font-size-18 font-weight-light text-ls-n1 text-lh-23">
											CATCH BIG <strong>{{ translate('deals') }}</strong> ON THE CAMERAS
										</div>
