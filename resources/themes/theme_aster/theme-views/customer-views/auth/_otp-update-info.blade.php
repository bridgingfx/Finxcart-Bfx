...
@section('content')
                        ...
                        <div class="card-body">
                            <div>
                                <div class="text-center">
                                    <div class="py-3">
                                        <img src="{{ theme_asset('assets/img/svg/otp-login-icon.svg') }}" alt="" width="50">
                                    </div>
                                    <div class="my-3">
                                        <p class="text-muted">
                                ...
                                <form class="" id="sign-up-form"
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        @elseif($updateType == 'social' && ($phoneVerification ?? true))
                                            <div class="form-group mb-2">
    ...
    @if($updateType == 'social' && ($phoneVerification ?? true))
...
@push('script')
    ...
    @if($user && $updateType == 'social' && ($phoneVerification ?? true))
        <script>
