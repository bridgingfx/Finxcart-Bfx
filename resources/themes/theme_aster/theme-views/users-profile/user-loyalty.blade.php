                            ...
                            <div
                                ...
                                <div class="dropdown">
                                    <button type="button"
                                            ...
                                            class="btn border-dark border-opacity-25 px-3 py-1 text-dark fs-14 align-items-center gap-10"
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end shadow transaction-filter_dropdown">
                                        <form action="{{ route('loyalty') }}" method="get" novalidate>
                                            <div
    ...
    <div class="modal fade" id="convertToCurrency" tabindex="-1" aria-labelledby="reviewModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('loyalty-exchange-currency') }}" method="POST" novalidate>
                    @csrf
