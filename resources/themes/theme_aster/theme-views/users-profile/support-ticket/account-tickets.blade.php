                                                ...
                                                <div class="d-flex flex-column gap-1">
                                                    <div class="media align-items-start justify-content-between">
                                                        ...
                                                        <div class="d-flex flex-wrap justify-content-end gap-2">
                                                            ...
                                                            @endif
                                                            <a href="{{ route('support-ticket.delete', ['id' => $supportTicket['id']]) }}"
                                                               class="btn btn-danger fw-semibold text-nowrap px-3"
                                                               title="{{ translate('delete') }}"
                                                               aria-label="{{ translate('delete') }}"
                                                               onclick="return confirm(@js(translate('Delete_this_ticket') . '?'))"><i class="fa fa-trash"></i></a>
                                                        </div>
                                                    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body px-sm-5">
                    <form action="{{route('ticket-submit')}}" id="open-ticket" method="post" novalidate>
                        @csrf
