...
@push('css_or_js')
    ...
    <style>
        ...
        .customer-chat-file-picker i { font-size: 18px; }
    </style>
@endpush
...
@section('content')
                        ...
                        <div class="flexible-grid md-down-1 width--15-625">
                            <div class="bg-light h-100 max-height-100vh-225px ">
                                <div class="p-3">
                                    ...
                                    <form action="#" class="mb-3" novalidate>
                                            ...
                                            <form method="post" class="mt-4 chatting-messages-form"
                                                ...
                                                <div class="d-flex border">
                                                    <div
                                                        ...
                                                        <label class="py-0 m-0 cursor-pointer customer-chat-file-picker" title="{{ translate('file') }}"><i class="bi bi-paperclip"></i>
    ...
    <span id="get-video-preview-icon"
          data-video-icon="{{ theme_asset('assets/img/icons/carbon_play-filled.svg') }}"></span>
@endsection
