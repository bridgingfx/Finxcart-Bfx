        ...
        <div class="container">
            <div class="d-flex align-items-center justify-content-between gap-3">
                ...
                <div class="search-box position-relative">
                    <form action="{{route('products')}}" type="submit" novalidate>
                        <div class="d-flex">
            ...
            <aside class="aside d-flex flex-column d-xl-none">
                ...
                <div>
                    <div class="aside-body" data-trigger="scrollbar">
                        <form action="{{route('products')}}" class="mb-3" novalidate>
                ...
                <ul class="list-unstyled list-separator mb-0 pe-2">
                    ...
                    @if(auth('customer')->check())
                        <li class="d-none d-xl-block dropdown">
                            <a href="javascript:" class="position-relative customer-notification-toggle"
                               id="customerNotificationDropdown" data-bs-toggle="dropdown"
                               data-bs-auto-close="outside" aria-expanded="false"
                               title="{{ translate('notifications') }}">
                                <i class="bi bi-bell fs-18"></i>
                                @if($customerUnreadNotificationCount > 0)
                                    <span class="count customer-notification-count">
                                        {{ $customerUnreadNotificationCount > 99 ? '99+' : $customerUnreadNotificationCount }}
                                    </span>
                                @endif
                            </a>
                            <div class="dropdown-menu dropdown-menu-end p-0 shadow-sm customer-notification-menu"
                                 aria-labelledby="customerNotificationDropdown"
                                 style="min-width:320px;max-height:400px;overflow-y:auto;">
                                <div class="d-flex align-items-center justify-content-between px-3 py-2 border-bottom">
                                    <span class="fw-bold fs-14 text-dark">{{ translate('notifications') }}</span>
                                </div>
    ...
    <script>
        (function () {
            ...
            function renderBadge(count) {
                var existing = badgeParent.querySelector('.customer-notification-count');
                if (count > 0) {
                    if (existing) {
                        existing.textContent = count > 99 ? '99+' : count;
                    } else {
                        var span = document.createElement('span');
                        span.className = 'count customer-notification-count';
