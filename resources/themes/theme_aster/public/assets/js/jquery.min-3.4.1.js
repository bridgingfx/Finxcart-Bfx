...
!function (e, t) {
    ...
    }), y.createHTMLDocument = ((Vt = E.implementation.createHTMLDocument("").body).innerHTML = "<form novalidate></form><form novalidate></form>", 2 === Vt.childNodes.length), k.parseHTML = function (e, t, n) {
