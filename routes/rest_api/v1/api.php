...
Route::group(['namespace' => 'RestAPI\v1', 'prefix' => 'v1', 'middleware' => ['api_lang']], function () {
    ...
    Route::group(['prefix' => 'auth', 'namespace' => 'auth'], function () {
        ...
        Route::controller(CustomerAPIAuthController::class)->group(function () {
            ...
            Route::post('check-email', 'checkEmail')->middleware('throttle:6,1');
            Route::post('check-phone', 'checkPhone')->middleware('throttle:6,1');
            ...
            Route::post('registration-with-otp', 'registrationWithOTP')->middleware('throttle:6,1');
            Route::post('existing-account-check', 'existingAccountCheck');
            Route::post('registration-with-social-media', 'registrationWithSocialMedia')->middleware('throttle:6,1');
            Route::post('forgot-password', 'passwordResetRequest')->middleware('throttle:6,1');
        });

        Route::group(['middleware' => 'apiGuestCheck'], function () {
            Route::controller(CustomerAPIAuthController::class)->group(function () {
                Route::post('verify-profile-info', 'verifyProfileInfo')->middleware('throttle:10,1');
            });
        });

        Route::controller(PhoneVerificationController::class)->group(function () {
            Route::post('resend-otp-check-phone', 'resend_otp_check_phone')->middleware('throttle:3,1');
        });
        Route::controller(EmailVerificationController::class)->group(function () {
            Route::post('resend-otp-check-email', 'resend_otp_check_email')->middleware('throttle:3,1');
        });
        ...
        Route::controller(SocialAuthController::class)->group(function () {
            Route::post('social-login', 'social_login')->middleware('throttle:10,1');
            Route::post('update-phone', 'update_phone');
            Route::post('social-customer-login', 'customerSocialLogin')->middleware('throttle:10,1');
            Route::post('existing-account-check', 'existingAccountCheck');
            Route::post('registration-with-social-media', 'registrationWithSocialMedia')->middleware('throttle:6,1');
        });
    });
    ...
    Route::group(['prefix' => 'customer', 'middleware' => 'apiGuestCheck'], function () {
        Route::group(['prefix' => 'order'], function () {
            Route::controller(OrderController::class)->group(function () {
                ...
                Route::post('digital-product-download-otp-resend', 'digital_product_download_otp_resend')->middleware('throttle:3,1');
            });
        });
    });
