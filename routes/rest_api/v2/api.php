...
Route::group(['namespace' => 'RestAPI\v2', 'prefix' => 'v2', 'middleware' => ['api_lang']], function () {
    Route::group(['prefix' => 'seller', 'namespace' => 'seller'], function () {
        ...
        Route::group(['prefix' => 'auth', 'namespace' => 'auth'], function () {
            ...
            Route::put('reset-password', 'ForgotPasswordController@reset_password_submit')->middleware('throttle:10,1');
        });

        Route::group(['prefix' => 'registration', 'namespace' => 'auth'], function () {
            Route::post('/', 'RegisterController@store')->middleware('throttle:6,1');
        });
    });
    ...
    Route::group(['prefix' => 'delivery-man', 'namespace' => 'delivery_man'], function () {
        ...
        Route::group(['prefix' => 'auth', 'namespace' => 'auth'], function () {
            Route::controller(LoginController::class)->group(function () {
                ...
                Route::post('forgot-password', 'reset_password_request')->middleware('throttle:6,1');
                Route::post('verify-otp', 'otp_verification_submit')->middleware('throttle:10,1');
                Route::post('reset-password', 'reset_password_submit')->middleware('throttle:10,1');
            });
        });
        ...
        Route::group(['middleware' => ['delivery_man_auth']], function () {
            Route::controller(DeliveryManController::class)->group(function () {
                ...
                Route::post('verify-order-delivery-otp', 'verify_order_delivery_otp')->middleware('throttle:10,1');
