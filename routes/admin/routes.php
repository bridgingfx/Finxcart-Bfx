...
use App\Http\Controllers\Admin\Vendor\PayoutKycController;
use App\Http\Controllers\Admin\Vendor\VendorVerificationController;
use App\Http\Controllers\Admin\ProductTierController;
use App\Http\Controllers\ChatController;
use App\Http\Controllers\AdminChatController;
use App\Http\Controllers\Admin\AdController;
use App\Http\Controllers\Admin\AdGroupController;
use App\Http\Controllers\Admin\AdsReportController ;
use App\Http\Controllers\InfluencerController;
use App\Http\Controllers\Admin\InfluencerAdminController;
use App\Http\Controllers\Admin\BrokerAdminController;
use App\Http\Controllers\Admin\Freelancer\FreelancerCategoryController;
use App\Http\Controllers\Admin\Freelancer\FreelancerSpecializationController;
use App\Http\Controllers\Admin\Freelancer\FreelancerAccountController;
use App\Http\Controllers\Admin\Freelancer\FreelancerVerificationController;
use App\Http\Controllers\Admin\Freelancer\FreelancerChattingController;
use App\Http\Controllers\Admin\Freelancer\FreelancerMessageController;
use App\Http\Controllers\Admin\Freelancer\FreelancerContractController as AdminFreelancerContractController;
use App\Http\Controllers\Admin\Freelancer\FreelancerQuoteController as AdminFreelancerQuoteController;
use App\Http\Controllers\Admin\Freelancer\FreelancerReviewController as AdminFreelancerReviewController;
use App\Http\Controllers\Admin\Freelancer\FreelancerServiceManageController as AdminFreelancerServiceManageController;
use App\Http\Controllers\Admin\Freelancer\FreelancerPortfolioManageController as AdminFreelancerPortfolioManageController;
use App\Http\Controllers\Admin\Freelancer\FreelancerLedgerController as AdminFreelancerLedgerController;

    Route::controller(SharedController::class)->group(function () {
        Route::get('change-language/{languageCode}', 'changeLanguagePath')->name('change-language-path');
    ...
    Route::resource('influencers', InfluencerAdminController::class)->except(['show']);
    Route::get('influencer-inquiries', [InfluencerAdminController::class, 'inquiries'])->name('influencers.inquiries');
    Route::get('brokers', [BrokerAdminController::class, 'index'])->name('brokers.index');
    Route::post('brokers', [BrokerAdminController::class, 'store'])->name('brokers.store');
    Route::get('brokers/{id}/edit', [BrokerAdminController::class, 'edit'])->name('brokers.edit');
    Route::put('brokers/{id}', [BrokerAdminController::class, 'update'])->name('brokers.update');
    Route::delete('brokers/{id}', [BrokerAdminController::class, 'destroy'])->name('brokers.destroy');

    // Review Management
    Route::get('broker-reviews', [BrokerAdminController::class, 'reviewList'])->name('brokers.reviews');
    Route::get('broker-reviews/approve/{id}', [BrokerAdminController::class, 'approveReview'])->name('brokers.reviews.approve');
    Route::delete('broker-reviews/{id}', [BrokerAdminController::class, 'deleteReview'])->name('brokers.reviews.delete');

    Route::group(['prefix' => 'freelancer/categories', 'as' => 'freelancer.categories.', 'middleware' => ['module:freelancer_management']], function () {
        Route::controller(FreelancerCategoryController::class)->group(function () {
    ...
    Route::group(['prefix' => 'freelancer/specializations', 'as' => 'freelancer.specializations.', 'middleware' => ['module:freelancer_management']], function () {
        Route::controller(FreelancerSpecializationController::class)->group(function () {
            Route::get('/', 'index')->name('index');
    ...
    Route::group(['prefix' => 'freelancer/accounts', 'as' => 'freelancer.accounts.', 'middleware' => ['module:freelancer_management']], function () {
        Route::controller(FreelancerAccountController::class)->group(function () {
            Route::get('/', 'index')->name('index');
            Route::get('create', 'create')->name('create');
            Route::post('store', 'store')->name('store');
            ...
            Route::post('account-status', 'updateAccountStatus')->name('account-status');
            Route::post('delete', 'destroy')->name('delete');
        });
    });

    Route::group(['prefix' => 'freelancer/verifications', 'as' => 'freelancer.verifications.', 'middleware' => ['module:freelancer_management']], function () {
        Route::controller(FreelancerVerificationController::class)->group(function () {
            Route::put('{id}', 'update')->name('update');
            Route::get('{id}/approve', 'approveView')->name('approve-view');
            Route::post('{id}/approve', 'approve')->name('approve');
            Route::post('{id}/reject', 'reject')->name('reject');
        });
    });

    Route::group(['prefix' => 'freelancer/services', 'as' => 'freelancer.services.', 'middleware' => ['module:freelancer_management']], function () {
        Route::controller(AdminFreelancerServiceManageController::class)->group(function () {
            Route::get('/', 'index')->name('index');
            Route::get('create', 'create')->name('create');
            Route::post('store', 'store')->name('store');
            Route::get('seller-options/{sellerId}', 'sellerOptions')->name('seller-options');
            Route::get('{service}/view', 'show')->name('show');
            Route::get('{service}/edit', 'edit')->name('edit');
            Route::put('{service}', 'update')->name('update');
        });
    });

    Route::group(['prefix' => 'freelancer/portfolio', 'as' => 'freelancer.portfolio.', 'middleware' => ['module:freelancer_management']], function () {
        Route::controller(AdminFreelancerPortfolioManageController::class)->group(function () {
            Route::get('/', 'index')->name('index');
            Route::get('{portfolio}/view', 'show')->name('show');
            Route::get('{portfolio}/edit', 'edit')->name('edit');
            Route::put('{portfolio}', 'update')->name('update');
        });
    });

    Route::group(['prefix' => 'freelancer/chats', 'as' => 'freelancer.chats.', 'middleware' => ['module:freelancer_management']], function () {
        Route::controller(FreelancerChattingController::class)->group(function () {
            Route::get('/', 'index')->name('index');
            Route::post('send', 'sendMessage')->name('send');
        });
    });

    Route::group(['prefix' => 'freelancer/messages', 'as' => 'freelancer.messages.', 'middleware' => ['module:freelancer_management']], function () {
        Route::controller(FreelancerMessageController::class)->group(function () {
            Route::get('/', 'index')->name('index');
            Route::get('unread-counts', 'unreadCounts')->name('unread-counts');
            Route::get('thread', 'threadMessages')->name('thread');
            Route::post('send', 'sendMessage')->name('send');
    ...
    Route::group(['prefix' => 'freelancer/contracts', 'as' => 'freelancer.contracts.', 'middleware' => ['module:freelancer_management']], function () {
        Route::controller(AdminFreelancerContractController::class)->group(function () {
            Route::get('/', 'index')->name('index');
            Route::get('view/{contract}', 'show')->name('view');
            Route::post('{contract}/cancellation/approve', 'approveCancellation')->name('cancellation.approve');
            Route::post('{contract}/cancellation/deny', 'denyCancellation')->name('cancellation.deny');
        });
    });

    Route::group(['prefix' => 'freelancer/quotes', 'as' => 'freelancer.quotes.', 'middleware' => ['module:freelancer_management']], function () {
        Route::controller(AdminFreelancerQuoteController::class)->group(function () {
            Route::get('/', 'index')->name('index');
            Route::get('view/{quote}', 'show')->name('view');
        });
    });

    Route::group(['prefix' => 'freelancer/ledger', 'as' => 'freelancer.ledger.', 'middleware' => ['module:freelancer_management']], function () {
        Route::get('/', [AdminFreelancerLedgerController::class, 'index'])->name('index');
    });

    Route::group(['prefix' => 'freelancer/audit-logs', 'as' => 'freelancer.audit-logs.', 'middleware' => ['module:freelancer_management']], function () {
        Route::get('/', [\App\Http\Controllers\Admin\Freelancer\FreelancerAuditLogController::class, 'index'])->name('index');
    });

    Route::group(['prefix' => 'freelancer/reviews', 'as' => 'freelancer.reviews.', 'middleware' => ['module:freelancer_management']], function () {
        Route::controller(AdminFreelancerReviewController::class)->group(function () {
            Route::get('/', 'index')->name('index');
            Route::post('delete/{review}', 'destroy')->name('delete');
            Route::post('delete-open/{review}', 'destroyOpen')->name('delete-open');
        });
    });

    Route::get('/chat', [ChatController::class, 'adminDashboard'])->name('chat.index');
    Route::get('/chat/{thread}', [ChatController::class, 'adminChatView'])->name('chat.show');
    Route::prefix('chat')->withoutMiddleware([\App\Http\Middleware\VerifyCsrfToken::class])->group(function () {
        Route::post('/send', [ChatController::class, 'sendMessage']);
    });
    Route::get('/chats/login', [AdminChatController::class, 'loginAsSupport'])
        ->name('chats.login');

        Route::get('/ads', function () {
            return redirect()->route('admin.ads.report');
        })->name('ads.dashboard'); // Redirect admin root to report

        // Ad Groups CRUD
        Route::resource('ad-groups', AdGroupController::class)->except(['show']);

        // Ads CRUD
        Route::resource('ads', AdController::class)->except(['show']);

        // Reports
        Route::get('ads-report', [AdsReportController::class, 'index'])->name('ads.report');
    ...
    Route::group(['prefix' => 'products', 'as' => 'products.', 'middleware' => ['module:product_management']], function () {
        Route::controller(ProductController::class)->group(function () {
            ...
            Route::get('get-all-categories-flat', 'getAllCategoriesFlat')->name('get-all-categories-flat');
    ...
    Route::group(['prefix' => 'category', 'as' => 'category.', 'middleware' => ['module:product_management']], function () {
        Route::controller(CategoryController::class)->group(function () {
            ...
            Route::post('delete-info', 'getDeleteInfo')->name('delete-info');
    ...
    Route::group(['prefix' => 'customer', 'as' => 'customer.', 'middleware' => ['module:user_section']], function () {
        Route::controller(CustomerController::class)->group(function () {
            ...
            Route::get(Customer::EDIT[URI] . '/{id}', 'getUpdateView')->name('edit');
            Route::post(Customer::EDIT[URI] . '/{id}', 'updateCustomer')->name('update');
    ...
    Route::group(['prefix' => 'vendors', 'as' => 'vendors.', 'middleware' => ['module:user_section']], function () {
        Route::controller(VendorController::class)->group(function () {
            ...
            Route::post('withdraw-delivery-status/{id}', 'updateWithdrawDeliveryStatus')->name('withdraw_delivery_status');
        });

        Route::group(['prefix' => 'vendor-verifications', 'as' => 'vendor-verifications.'], function () {
            Route::controller(VendorVerificationController::class)->group(function () {
                Route::get('', 'index')->name('index');
                Route::put('{id}', 'update')->name('update');
                Route::post('{id}/approve', 'approve')->name('approve');
                Route::post('{id}/reject', 'reject')->name('reject');
        ...
        Route::group(['prefix' => 'payout-kyc', 'as' => 'payout-kyc.'], function () {
            Route::controller(PayoutKycController::class)->group(function () {
                Route::get('', 'index')->name('index');
                Route::post('{id}/approve', 'approve')->name('approve');
                Route::post('{id}/reject', 'reject')->name('reject');
            });
    ...
    Route::group(['prefix' => 'vendor-subscriptions', 'as' => 'vendor-subscriptions.', 'middleware' => ['module:user_section']], function () {
        Route::get('/', [\App\Http\Controllers\Admin\Vendor\VendorSubscriptionController::class, 'index'])->name('index');
        Route::patch('/{id}/cancel', [\App\Http\Controllers\Admin\Vendor\VendorSubscriptionController::class, 'cancel'])->name('cancel');
        Route::get('/payments/{vendorId}', [\App\Http\Controllers\Admin\Vendor\VendorSubscriptionController::class, 'payments'])->name('payments');
    });
    ...
    Route::group(['prefix' => 'transaction', 'as' => 'transaction.', 'middleware' => ['module:report']], function () {
        Route::controller(TransactionReportController::class)->group(function () {
            ...
            Route::get('commission-ledger', 'commissionLedgerList')->name('commission-ledger');
            Route::get('commission-ledger-export-excel', 'commissionLedgerExportExcel')->name('commission-ledger-export-excel');
            Route::get('commission-ledger-summary-pdf', 'commission_ledger_summary_pdf')->name('commission-ledger-summary-pdf');
            Route::post('commission-ledger/service-charge', 'updateCommissionServiceCharge')->name('commission-ledger.service-charge');
    ...
    Route::group(['prefix' => 'contact', 'as' => 'contact.', 'middleware' => ['module:support_section']], function () {
        Route::controller(ContactController::class)->group(function () {
            ...
            Route::get(Contact::FILTER[URI], 'getListByFilter')->name('filter');
            Route::post(Contact::FILTER[URI], 'getListByFilter');
        ...
        Route::group(['middleware' => ['module:3rd_party_setup']], function () {
            ...
            Route::group(['prefix' => 'mail', 'as' => 'mail.'], function () {
                Route::controller(MailController::class)->group(function () {
                    ...
                    Route::post(Mail::UPDATE_BREVO[URI], 'updateBrevo')->name('update-brevo');
    ...
    Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
        ...
        Route::group(['middleware' => ['module:business_settings']], function () {
            ...
            Route::controller(VendorSettingsController::class)->group(function () {
                Route::post('kyc/update', 'updateKyc')->name('kyc.update');
            });
...
Route::group(['prefix' => 'tiers', 'as' => 'tiers.', 'middleware' => ['module:user_section']], function () {
    Route::controller(ProductTierController::class)->group(function () {
        // List all tiers
        Route::get('/', 'index')->name('index');
