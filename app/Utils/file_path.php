...
if (!function_exists('getStorageImages')) {
    function getStorageImages($path, $type = null, $source = null): string
    {
        ...
        $placeholderMap = [
            ...
            // A square placeholder — placeholder-4-1.png is a 1500x375 wide banner
            // image, which rendered visibly stretched/pixelated when squeezed into
            // a fixed-width logo <img> slot (email footer/header logos).
            'backend-logo' => 'back-end/img/placeholder/brand.png',
