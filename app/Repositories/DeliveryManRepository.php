...
class DeliveryManRepository implements DeliveryManRepositoryInterface
{
    ...
    {
        // $relations only names which relation to whereHas/withCount on (e.g. 'deliveredOrders') —
        // both current callers only read the resulting *_count aggregate, never the full relation,
        // so it's intentionally not passed to with() here.
