...
class FreelancerSpecializationAddRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'name' => 'required|array',
            'name.*' => 'required|array',
            'name.0' => 'required|array|min:1',
            'name.0.*' => [
                'required',
                'max:100',
                'distinct',
                Rule::unique('freelancer_specializations', 'name'),
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'name.0.*.distinct' => translate('freelancer_specialization_has_already_been_taken'),
