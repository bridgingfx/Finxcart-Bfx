...
class ProfileController extends BaseController
{
    ...
    public function getBankInfoUpdateView(string|int $id): View|RedirectResponse
    {
        ...
        return view('vendor-views.profile.bank-info-update-view', compact('vendor', 'wallet'));
    }
    ...
    public function updateBankInfo(VendorBankInfoRequest $request, string|int $id): RedirectResponse
    {
        ...
        if (session()->has('pending_tier_id')) {
            return redirect()->route('vendor.tier.index')
                ->with('success', translate('Bank_details_saved!_Select_your_plan_below_to_activate_it.'));
        }
    ...
    public function removeBankInfo(string|int $id): RedirectResponse
    {
        ...
        return redirect()->route('vendor.profile.update-bank-info', [$vendorId]);
    }
