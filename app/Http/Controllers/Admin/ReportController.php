...
class ReportController extends Controller
{
    public function admin_earning(Request $request)
    {
        ...
        $total_stores_query = Seller::approved();
    ...
    public function vendorEarning(Request $request)
    {
        ...
        $total_seller_query = Seller::approved();
    ...
    public function seller_earning_query_table($start_date, $end_date)
    {
        ...
        $sellersById = Seller::whereIn('id', $seller_earnings_commission->pluck('seller_id'))->get()->keyBy('id');
        foreach ($seller_earnings_commission as $data) {
            $seller = $sellersById->get($data->seller_id);
        ...
        $sellersById = Seller::whereIn('id', $discount_given_bearer_admin->pluck('seller_id'))->get()->keyBy('id');
        ...
        $sellersById = Seller::whereIn('id', $shipping_earns->pluck('seller_id'))->get()->keyBy('id');
        ...
        $sellersById = Seller::whereIn('id', $deliveryman_incentives->pluck('seller_id'))->get()->keyBy('id');
        ...
        $sellersById = Seller::whereIn('id', $discounts_given->pluck('seller_id'))->get()->keyBy('id');
        ...
        $sellersById = Seller::whereIn('id', $taxes->pluck('seller_id'))->get()->keyBy('id');
        ...
        $sellersById = Seller::whereIn('id', $refunds->pluck('payer_id'))->get()->keyBy('id');
        foreach ($refunds as $data) {
            $seller = $sellersById->get($data->payer_id);
