...
class SubSubCategoryController extends BaseController
{
    ...
    public function getAddView(Request $request): View
    {
        $categories = $this->categoryRepo->getListWhere(
            ...
            filters: ['position' => 2],
            relations: ['parent.parent.translations', 'parent.translations', 'translations'],
    ...
    public function add(SubCategoryAddRequest $request, CategoryService $categoryService): RedirectResponse
    {
        ...
        return redirect()->route('admin.sub-sub-category.view');
    }
    ...
    public function getDeleteInfo(Request $request): JsonResponse
{
    ...
    if (!$category) {
        return response()->json(['subCount' => 0, 'subSubCount' => 0, 'productCount' => 0, 'position' => 2]);
    }
