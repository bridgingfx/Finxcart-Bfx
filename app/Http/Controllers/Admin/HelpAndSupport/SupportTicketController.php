...
class SupportTicketController extends BaseController
{
    ...
    public function getListView(Request $request): View
    {
        $tickets = $this->supportTicketRepo->getListWhere(
            ...
            // The view renders $ticket->customer->image_full_url per row, which lazy-loads
            // the customer's `storage` relation once per row without this nested eager load.
            relations: ['customer.storage'],
    ...
    {
        $supportTicket = $this->supportTicketRepo->getListWhere(filters: ['id'=>$id], relations: ['conversations', 'customer'], dataLimit: 'all');
