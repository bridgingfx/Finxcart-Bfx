...
class NotificationController extends BaseController
{
    ...
    public function add(NotificationRequest $request): RedirectResponse
    {
        ...
        try {
            ...
            $pushResponse = $this->sendPushNotificationToTopic($notification);
            if (!$this->wasPushSentSuccessfully($pushResponse)) {
    ...
    private function wasPushSentSuccessfully(mixed $response): bool
    {
