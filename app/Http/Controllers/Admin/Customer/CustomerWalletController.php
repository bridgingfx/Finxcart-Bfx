...
class CustomerWalletController extends BaseController
{
    ...
    public function getListView(Request $request): View
    {
        ...
        // The report view renders $transaction->user->f_name per row; without eager-loading
        // this lazy-loads once per row (N+1).
        $transactions = $this->walletTransactionRepo->getListWhere(filters: $filters, relations: ['user'], dataLimit: getWebConfig(name: WebConfigKey::PAGINATION_LIMIT));
        $customer = "all";
