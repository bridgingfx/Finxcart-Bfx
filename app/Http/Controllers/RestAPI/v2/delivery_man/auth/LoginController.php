    ...
    public function reset_password_request(Request $request)
    {
        ...
        if (isset($delivery_man)) {
            ...
            if ($verification_by == 'email') {
                ...
                // SMS gateway call is real network I/O with no queue worker configured —
                // defer past the response so the app isn't stuck waiting on it.
                dispatch(function () use ($phone_number, $otp) {
                    try {
