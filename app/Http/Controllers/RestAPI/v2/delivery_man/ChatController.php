...
class ChatController extends Controller
{
    public function list(Request $request, $type)
    {
        ...
        if ($unique_chat_ids) {
            ...
            $latestIdsByPartner = Chatting::where(['delivery_man_id' => $delivery_man['id']])
            ...
            $unseenCountsByPartner = Chatting::where(['delivery_man_id' => $delivery_man['id']])
                ->whereIn($id_param, $partnerIds)
                ->where('seen_by_delivery_man', '0')
