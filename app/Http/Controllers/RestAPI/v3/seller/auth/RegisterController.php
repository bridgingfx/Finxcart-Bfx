...
class RegisterController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            // Scoped to Vendor accounts (seller_type NULL) — Freelancer accounts may
            // legitimately share this email/phone, they're a separate account type.
            'email'         => [
                'required',
                \Illuminate\Validation\Rule::unique('sellers')->where(fn ($query) => $query->whereNull('seller_type')),
            ],
