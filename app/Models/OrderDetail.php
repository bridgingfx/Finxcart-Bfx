...
class OrderDetail extends Model
{
    ...
    protected $fillable = [
        ...
        'variant',
        'variation',
        'digital_file_sent_at',
        'digital_file_first_accessed_at',
        'digital_access_ip',
        'digital_delivery_type',
        'digital_delivery_value',
        'product_type',
    ];
    ...
    protected $casts = [
        ...
        'digital_file_sent_at' => 'datetime',
        'digital_file_first_accessed_at' => 'datetime',
    ];
    ...
    public function shipmentItem(): \Illuminate\Database\Eloquent\Relations\HasOne
    {
        return $this->hasOne(ShipmentItem::class, 'order_detail_id');
    }
