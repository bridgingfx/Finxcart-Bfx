...
class Order extends Model
{
    ...
    /* this order's own shipment (works for both a child/standalone order and,
       via order_id, the main order it belongs to) */
    public function sourceShipment(): HasOne
    {
        return $this->hasOne(Shipment::class, 'source_order_id');
    }
