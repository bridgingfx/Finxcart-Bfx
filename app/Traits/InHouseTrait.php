...
trait InHouseTrait
{
    ...
    public function getInHouseShopObject(): Shop
    {
        ...
        $is_vacation_mode_now = !empty($inHouseVacation['status']) && $start_date && $end_date && ($current_date >= $start_date) && ($current_date <= $end_date) ? 1 : 0;
        $inHouseShop = new Shop([
            ...
            'temporary_close' => getWebConfig(name: 'temporary_close')['status'] ?? 0,
