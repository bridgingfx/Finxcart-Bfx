...
$(document).ready(function () {
    ...
    // isn't yanked back to the bottom mid-read. Skipped while a send is in
    // flight so the two responses can't race and clobber each other.
    (function () {
        ...
        function pollTypingStatus() {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (isTyping) {
                        let partnerName = $(".profile-name").first().text().trim();
